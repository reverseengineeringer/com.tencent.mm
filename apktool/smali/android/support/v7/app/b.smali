...
# static fields
.field private static final jc:[I
...
.field private jg:Landroid/support/v7/a/a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/app/b;->jc:[I
...
.method constructor <init>(Landroid/support/v7/app/ActionBarActivity;)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/b;->jl:Ljava/lang/Runnable;
...
.method private c(Landroid/support/v7/internal/view/menu/f;)V
    ...
    .prologue
    .line 421
    iget-object v0, p0, Landroid/support/v7/app/b;->jf:Landroid/support/v7/internal/view/menu/f;
    ...
    iget-object v1, p0, Landroid/support/v7/app/b;->je:Landroid/support/v7/internal/view/menu/e;

    invoke-virtual {v0, v1}, Landroid/support/v7/internal/view/menu/f;->b(Landroid/support/v7/internal/view/menu/l;)V

    .line 428
    :cond_2
    iput-object p1, p0, Landroid/support/v7/app/b;->jf:Landroid/support/v7/internal/view/menu/f;

    .line 430
    if-eqz p1, :cond_3

    iget-object v0, p0, Landroid/support/v7/app/b;->je:Landroid/support/v7/internal/view/menu/e;
    ...
    .line 434
    :cond_3
    iget-object v0, p0, Landroid/support/v7/app/b;->jd:Landroid/support/v7/internal/widget/ActionBarView;
...
.method public final C(I)Z
    ...
    .line 244
    :pswitch_0
    iget-object v0, p0, Landroid/support/v7/app/b;->iX:Landroid/support/v7/app/ActionBarActivity;
    ...
    .line 232
    :pswitch_1
    iput-boolean v0, p0, Landroid/support/v7/app/b;->ja:Z

    goto :goto_0

    .line 235
    :pswitch_2
    iput-boolean v0, p0, Landroid/support/v7/app/b;->jb:Z
...
.method public final F()V
    ...
    iget-object v1, p0, Landroid/support/v7/app/b;->jl:Ljava/lang/Runnable;
...
.method public aO()Landroid/support/v7/app/ActionBar;
    ...
    iget-object v1, p0, Landroid/support/v7/app/b;->iX:Landroid/support/v7/app/ActionBarActivity;

    iget-object v2, p0, Landroid/support/v7/app/b;->iX:Landroid/support/v7/app/ActionBarActivity;
...
.method public final aQ()V
    ...
    .prologue
    .line 95
    iget-boolean v0, p0, Landroid/support/v7/app/b;->ja:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, Landroid/support/v7/app/b;->jh:Z
    ...
    invoke-static {v1}, Landroid/support/v7/internal/view/a;->k(Landroid/content/Context;)Landroid/support/v7/internal/view/a;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/app/e;->n(Z)V
...
.method public final aR()Z
    ...
    .line 442
    iget-object v2, p0, Landroid/support/v7/app/b;->jg:Landroid/support/v7/a/a;

    if-eqz v2, :cond_1

    .line 443
    iget-object v1, p0, Landroid/support/v7/app/b;->jg:Landroid/support/v7/a/a;
    ...
    .line 448
    :cond_1
    iget-object v2, p0, Landroid/support/v7/app/b;->jd:Landroid/support/v7/internal/widget/ActionBarView;

    if-eqz v2, :cond_4

    iget-object v2, p0, Landroid/support/v7/app/b;->jd:Landroid/support/v7/internal/widget/ActionBarView;

    iget-object v3, v2, Landroid/support/v7/internal/widget/ActionBarView;->or:Landroid/support/v7/internal/widget/ActionBarView$a;

    if-eqz v3, :cond_2

    iget-object v2, v2, Landroid/support/v7/internal/widget/ActionBarView;->or:Landroid/support/v7/internal/widget/ActionBarView$a;

    iget-object v2, v2, Landroid/support/v7/internal/widget/ActionBarView$a;->oy:Landroid/support/v7/internal/view/menu/h;
    ...
    .line 449
    iget-object v1, p0, Landroid/support/v7/app/b;->jd:Landroid/support/v7/internal/widget/ActionBarView;

    iget-object v2, v1, Landroid/support/v7/internal/widget/ActionBarView;->or:Landroid/support/v7/internal/widget/ActionBarView$a;
    ...
    .line 449
    :cond_3
    iget-object v1, v1, Landroid/support/v7/internal/widget/ActionBarView;->or:Landroid/support/v7/internal/widget/ActionBarView$a;

    iget-object v1, v1, Landroid/support/v7/internal/widget/ActionBarView$a;->oy:Landroid/support/v7/internal/view/menu/h;
...
.method final aU()V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/app/ActionBarActivity;->D(I)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/b;->jd:Landroid/support/v7/internal/widget/ActionBarView;
    ...
    iget v3, v0, Landroid/support/v7/internal/widget/ActionBarView;->og:I

    invoke-direct {v1, v2, v3}, Landroid/support/v7/internal/widget/ProgressBarICS;-><init>(Landroid/content/Context;I)V

    iput-object v1, v0, Landroid/support/v7/internal/widget/ActionBarView;->oc:Landroid/support/v7/internal/widget/ProgressBarICS;
    ...
    iget v3, v0, Landroid/support/v7/internal/widget/ActionBarView;->oh:I

    invoke-direct {v1, v2, v3}, Landroid/support/v7/internal/widget/ProgressBarICS;-><init>(Landroid/content/Context;I)V

    iput-object v1, v0, Landroid/support/v7/internal/widget/ActionBarView;->od:Landroid/support/v7/internal/widget/ProgressBarICS;

    iget-object v1, v0, Landroid/support/v7/internal/widget/ActionBarView;->od:Landroid/support/v7/internal/widget/ProgressBarICS;
    ...
    iput-boolean v0, p0, Landroid/support/v7/app/b;->jh:Z

    .line 224
    invoke-virtual {p0}, Landroid/support/v7/app/b;->F()V
...
.method public final e(Ljava/lang/CharSequence;)V
    ...
    iget-boolean v1, v0, Landroid/support/v7/internal/widget/ActionBarView;->oi:Z
...
.method public final onCreatePanelView(I)Landroid/view/View;
    ...
    .line 261
    iget-object v1, p0, Landroid/support/v7/app/b;->jf:Landroid/support/v7/internal/view/menu/f;

    .line 263
    iget-object v3, p0, Landroid/support/v7/app/b;->jg:Landroid/support/v7/a/a;
    ...
    iget-object v3, p0, Landroid/support/v7/app/b;->jf:Landroid/support/v7/internal/view/menu/f;

    if-eqz v3, :cond_4

    iget-object v3, p0, Landroid/support/v7/app/b;->je:Landroid/support/v7/internal/view/menu/e;

    if-nez v3, :cond_6

    sget-object v3, Lcom/tencent/mm/R$b;->WY:[I
    ...
    iput-object v3, p0, Landroid/support/v7/app/b;->je:Landroid/support/v7/internal/view/menu/e;

    iget-object v3, p0, Landroid/support/v7/app/b;->je:Landroid/support/v7/internal/view/menu/e;

    iput-object p0, v3, Landroid/support/v7/internal/view/menu/e;->lC:Landroid/support/v7/internal/view/menu/l$a;

    iget-object v3, p0, Landroid/support/v7/app/b;->jf:Landroid/support/v7/internal/view/menu/f;

    iget-object v4, p0, Landroid/support/v7/app/b;->je:Landroid/support/v7/internal/view/menu/e;
    ...
    iget-object v2, v3, Landroid/support/v7/internal/view/menu/e;->lX:Landroid/support/v7/internal/view/menu/e$a;
    ...
    iput-object v2, v3, Landroid/support/v7/internal/view/menu/e;->lX:Landroid/support/v7/internal/view/menu/e$a;
    ...
    iget-object v0, v3, Landroid/support/v7/internal/view/menu/e;->lU:Landroid/support/v7/internal/view/menu/ExpandedMenuView;

    if-nez v0, :cond_3

    iget-object v0, v3, Landroid/support/v7/internal/view/menu/e;->ib:Landroid/view/LayoutInflater;
    ...
    iput-object v0, v3, Landroid/support/v7/internal/view/menu/e;->lU:Landroid/support/v7/internal/view/menu/ExpandedMenuView;
    ...
    invoke-virtual {v3, v6}, Landroid/support/v7/internal/view/menu/e;->p(Z)V
