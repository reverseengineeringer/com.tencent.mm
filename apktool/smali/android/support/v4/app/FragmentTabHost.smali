...
.field private cn:Landroid/support/v4/app/e;
...
.field private cu:Landroid/widget/TabHost$OnTabChangeListener;

.field private cv:Landroid/support/v4/app/FragmentTabHost$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->cs:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->ct:Landroid/widget/FrameLayout;

    iget-object v2, p0, Landroid/support/v4/app/FragmentTabHost;->ct:Landroid/widget/FrameLayout;
...
.method private a(Ljava/lang/String;Landroid/support/v4/app/h;)Landroid/support/v4/app/h;
    ...
    :goto_0
    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->cs:Ljava/util/ArrayList;
    ...
    .line 328
    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->cv:Landroid/support/v4/app/FragmentTabHost$a;
    ...
    .line 330
    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->cn:Landroid/support/v4/app/e;
    ...
    iget-object v0, v0, Landroid/support/v4/app/FragmentTabHost$a;->ak:Landroid/support/v4/app/Fragment;
    ...
    .line 338
    iget-object v0, v1, Landroid/support/v4/app/FragmentTabHost$a;->ak:Landroid/support/v4/app/Fragment;
    ...
    iget-object v2, v1, Landroid/support/v4/app/FragmentTabHost$a;->cy:Ljava/lang/Class;

    invoke-virtual {v2}, Ljava/lang/Class;->getName()Ljava/lang/String;

    move-result-object v2

    iget-object v3, v1, Landroid/support/v4/app/FragmentTabHost$a;->cz:Landroid/os/Bundle;
    ...
    iput-object v0, v1, Landroid/support/v4/app/FragmentTabHost$a;->ak:Landroid/support/v4/app/Fragment;

    .line 341
    iget v0, p0, Landroid/support/v4/app/FragmentTabHost;->aW:I

    iget-object v2, v1, Landroid/support/v4/app/FragmentTabHost$a;->ak:Landroid/support/v4/app/Fragment;
    ...
    :cond_4
    :goto_2
    iput-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->cv:Landroid/support/v4/app/FragmentTabHost$a;
...
.method protected onAttachedToWindow()V
    ...
    .line 255
    iget-object v4, p0, Landroid/support/v4/app/FragmentTabHost;->cn:Landroid/support/v4/app/e;
    ...
    iput-object v4, v0, Landroid/support/v4/app/FragmentTabHost$a;->ak:Landroid/support/v4/app/Fragment;

    .line 256
    iget-object v4, v0, Landroid/support/v4/app/FragmentTabHost$a;->ak:Landroid/support/v4/app/Fragment;

    if-eqz v4, :cond_0

    iget-object v4, v0, Landroid/support/v4/app/FragmentTabHost$a;->ak:Landroid/support/v4/app/Fragment;

    iget-boolean v4, v4, Landroid/support/v4/app/Fragment;->aZ:Z
    ...
    .line 261
    iput-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->cv:Landroid/support/v4/app/FragmentTabHost$a;
    ...
    .line 266
    iget-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->cn:Landroid/support/v4/app/e;
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/FragmentTabHost;->cw:Z
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 301
    iget-object v0, p1, Landroid/support/v4/app/FragmentTabHost$SavedState;->cx:Ljava/lang/String;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iput-object v0, v1, Landroid/support/v4/app/FragmentTabHost$SavedState;->cx:Ljava/lang/String;
...
.method public onTabChanged(Ljava/lang/String;)V
    ...
    .prologue
    .line 306
    iget-boolean v0, p0, Landroid/support/v4/app/FragmentTabHost;->cw:Z
    ...
    .line 312
    :cond_0
    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->cu:Landroid/widget/TabHost$OnTabChangeListener;
...
.method public setOnTabChangedListener(Landroid/widget/TabHost$OnTabChangeListener;)V
    ...
    .prologue
    .line 219
    iput-object p1, p0, Landroid/support/v4/app/FragmentTabHost;->cu:Landroid/widget/TabHost$OnTabChangeListener;
