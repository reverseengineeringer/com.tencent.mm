.class Landroid/support/v4/app/aa$p;
.super Landroid/support/v4/app/aa$o;
.source "SourceFile"
...
.method constructor <init>()V
    ...
    .prologue
    .line 638
    invoke-direct {p0}, Landroid/support/v4/app/aa$o;-><init>()V
...
.method public b(Landroid/support/v4/app/aa$d;)Landroid/app/Notification;
    ...
    .prologue
    .line 641
    new-instance v1, Landroid/support/v4/app/ah$a;
    ...
    invoke-direct/range {v1 .. v24}, Landroid/support/v4/app/ah$a;-><init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZZILjava/lang/CharSequence;ZLjava/util/ArrayList;Landroid/os/Bundle;Ljava/lang/String;ZLjava/lang/String;)V
    ...
    .line 649
    iget-object v2, v1, Landroid/support/v4/app/ah$a;->en:Ljava/util/List;

    invoke-static {v2}, Landroid/support/v4/app/ag;->c(Ljava/util/List;)Landroid/util/SparseArray;

    move-result-object v2

    if-eqz v2, :cond_0

    iget-object v3, v1, Landroid/support/v4/app/ah$a;->mExtras:Landroid/os/Bundle;
    ...
    :cond_0
    iget-object v2, v1, Landroid/support/v4/app/ah$a;->ei:Landroid/app/Notification$Builder;

    iget-object v3, v1, Landroid/support/v4/app/ah$a;->mExtras:Landroid/os/Bundle;

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setExtras(Landroid/os/Bundle;)Landroid/app/Notification$Builder;

    iget-object v1, v1, Landroid/support/v4/app/ah$a;->ei:Landroid/app/Notification$Builder;
