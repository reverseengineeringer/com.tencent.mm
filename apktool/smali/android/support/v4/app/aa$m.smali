.class final Landroid/support/v4/app/aa$m;
...
.method public final b(Landroid/support/v4/app/aa$d;)Landroid/app/Notification;
    ...
    .prologue
    .line 558
    iget-object v0, p1, Landroid/support/v4/app/aa$d;->mContext:Landroid/content/Context;

    iget-object v1, p1, Landroid/support/v4/app/aa$d;->dS:Landroid/app/Notification;
    ...
    iget-object v4, p1, Landroid/support/v4/app/aa$d;->dA:Ljava/lang/CharSequence;

    iget-object v5, p1, Landroid/support/v4/app/aa$d;->dy:Landroid/widget/RemoteViews;

    iget v6, p1, Landroid/support/v4/app/aa$d;->dB:I

    iget-object v7, p1, Landroid/support/v4/app/aa$d;->dw:Landroid/app/PendingIntent;

    iget-object v8, p1, Landroid/support/v4/app/aa$d;->dx:Landroid/app/PendingIntent;

    iget-object v9, p1, Landroid/support/v4/app/aa$d;->dz:Landroid/graphics/Bitmap;
