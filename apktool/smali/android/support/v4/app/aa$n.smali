.class final Landroid/support/v4/app/aa$n;
...
.method public final b(Landroid/support/v4/app/aa$d;)Landroid/app/Notification;
    ...
    iget-object v1, v0, Landroid/support/v4/app/aa$d;->mContext:Landroid/content/Context;

    move-object/from16 v0, p1

    iget-object v2, v0, Landroid/support/v4/app/aa$d;->dS:Landroid/app/Notification;

    move-object/from16 v0, p1

    iget-object v3, v0, Landroid/support/v4/app/aa$d;->du:Ljava/lang/CharSequence;

    move-object/from16 v0, p1

    iget-object v4, v0, Landroid/support/v4/app/aa$d;->dv:Ljava/lang/CharSequence;

    move-object/from16 v0, p1

    iget-object v5, v0, Landroid/support/v4/app/aa$d;->dA:Ljava/lang/CharSequence;

    move-object/from16 v0, p1

    iget-object v6, v0, Landroid/support/v4/app/aa$d;->dy:Landroid/widget/RemoteViews;

    move-object/from16 v0, p1

    iget v7, v0, Landroid/support/v4/app/aa$d;->dB:I

    move-object/from16 v0, p1

    iget-object v8, v0, Landroid/support/v4/app/aa$d;->dw:Landroid/app/PendingIntent;

    move-object/from16 v0, p1

    iget-object v9, v0, Landroid/support/v4/app/aa$d;->dx:Landroid/app/PendingIntent;

    move-object/from16 v0, p1

    iget-object v10, v0, Landroid/support/v4/app/aa$d;->dz:Landroid/graphics/Bitmap;

    move-object/from16 v0, p1

    iget v11, v0, Landroid/support/v4/app/aa$d;->dG:I

    move-object/from16 v0, p1

    iget v12, v0, Landroid/support/v4/app/aa$d;->dH:I

    move-object/from16 v0, p1

    iget-boolean v13, v0, Landroid/support/v4/app/aa$d;->dI:Z
