...
{
  private static Class<AssetManager> mwu;
  private static Method mwv;
  
  static
  {
    try
    {
      mwu = AssetManager.class;
      mwv = AssetManager.class.getDeclaredMethod("addAssetPath", new Class[] { String.class });
      return;
    }
    catch (Throwable localThrowable) {}catch (NoSuchMethodException localNoSuchMethodException) {}
  }
  
  private static PackageInfo KE(String paramString)
  {
    for (;;)
    {
      int i;
  ...
  private static String a(Context paramContext, File paramFile, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      paramContext = KE(paramFile.getAbsolutePath());
  ...
  public static String s(File paramFile)
  {
    ...
    //   105: astore 6
    //   107: ldc -25
    //   109: invokestatic 237	java/security/MessageDigest:getInstance	(Ljava/lang/String;)Ljava/security/MessageDigest;
    //   112: astore 7
    //   114: new 239	java/io/FileInputStream
    //   117: dup
    //   118: aload_0
    //   119: invokespecial 242	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   122: astore_0
    //   123: sipush 8192
    ...
    //   130: aload_0
    //   131: aload 8
    //   133: invokevirtual 245	java/io/FileInputStream:read	([B)I
    //   136: istore_2
    //   137: iload_2
    //   138: iconst_m1
    ...
    //   146: iconst_0
    //   147: iload_2
    //   148: invokevirtual 249	java/security/MessageDigest:update	([BII)V
    //   151: goto -21 -> 130
    //   154: astore 5
    //   156: aload_0
    //   157: ifnull +7 -> 164
    //   160: aload_0
    //   161: invokevirtual 250	java/io/FileInputStream:close	()V
    //   164: aconst_null
    //   165: astore 5
    //   167: aload 5
    //   169: areturn
    //   170: aload 7
    //   172: invokevirtual 254	java/security/MessageDigest:digest	()[B
    //   175: astore 7
    //   177: iconst_0
    //   178: istore_2
    //   179: goto +67 -> 246
    //   182: new 25	java/lang/String
    //   185: dup
    //   186: aload 6
    //   188: invokespecial 204	java/lang/String:<init>	([C)V
    //   191: astore 6
    //   193: aload 6
    //   195: astore 5
    //   197: aload_0
    //   198: ifnull -31 -> 167
    //   201: aload_0
    //   202: invokevirtual 250	java/io/FileInputStream:close	()V
    //   205: aload 6
    //   207: areturn
    //   208: astore_0
    //   209: aload 6
    ...
    //   217: ifnull +7 -> 224
    //   220: aload_0
    //   221: invokevirtual 250	java/io/FileInputStream:close	()V
    //   224: aload 5
    //   226: athrow
    //   227: astore_0
    //   228: goto -64 -> 164
  ...
  private static String t(File paramFile)
  {
    for (;;)
    {
      try
      {
        ...
        String str1 = bm(a(localJarFile, paramFile, arrayOfByte)[0].getEncoded());
        ...
        if (localEnumeration.hasMoreElements())
        {
          ...
          if (paramFile != null)
          {
            paramFile = bm(paramFile[0].getEncoded());
            if (paramFile == null)
            {
