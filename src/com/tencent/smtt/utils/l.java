...
public final class l
{
  ...
  /* Error */
  private static Map<String, String> EX(String paramString)
  {
    // Byte code:
    //   0: aload_0
  ...
  private static Map<String, String> bsv()
  {
    ...
    //   30: dup
    //   31: ldc -92
    //   33: invokespecial 81	java/io/File:<init>	(Ljava/lang/String;)V
    //   36: astore_0
    //   37: aload_0
    //   38: invokevirtual 85	java/io/File:exists	()Z
    //   41: ifne +138 -> 179
    //   44: new 78	java/io/File
    //   47: dup
    //   48: ldc -90
    //   50: invokespecial 81	java/io/File:<init>	(Ljava/lang/String;)V
    //   53: astore_0
    //   54: aload_0
    //   55: invokevirtual 85	java/io/File:exists	()Z
    //   58: ifeq +114 -> 172
    //   61: new 168	java/io/FileInputStream
    //   64: dup
    //   65: aload_0
    //   66: invokespecial 171	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   69: astore_2
    //   70: aload_2
    //   71: invokestatic 177	com/tencent/smtt/utils/e:n	(Ljava/io/InputStream;)[B
    //   74: astore 4
    //   76: aload_1
    //   77: astore_0
    //   78: aload_2
    ...
    //   89: aload 4
    //   91: ldc -77
    //   93: invokespecial 182	java/lang/String:<init>	([BLjava/lang/String;)V
    //   96: astore_0
    //   97: aload_2
    //   98: astore_3
    //   99: aload_0
    ...
    //   106: astore_2
    //   107: aload_3
    //   108: invokevirtual 185	java/io/FileInputStream:close	()V
    //   111: aload_0
    //   112: astore_2
    //   113: aload_2
    //   114: invokestatic 187	com/tencent/smtt/utils/l:EX	(Ljava/lang/String;)Ljava/util/Map;
    //   117: areturn
    //   118: astore_0
    //   119: aload_3
    //   120: astore_1
    ...
    //   142: astore_2
    //   143: aload_0
    //   144: invokevirtual 185	java/io/FileInputStream:close	()V
    //   147: aload_1
    //   148: astore_2
    //   149: goto -36 -> 113
    //   152: astore_0
  ...
  private String bsw()
  {
    ...
    if ((localObject != null) && (((Map)localObject).size() > 0))
    {
      ...
      } while (TextUtils.equals(h.aH(localFile.lastModified()), (CharSequence)localObject));
    }
    return "";
  }
  ...
  public final boolean bn(Context paramContext, String paramString)
  {
    if (paramString != null) {}
    for (;;)
    {
