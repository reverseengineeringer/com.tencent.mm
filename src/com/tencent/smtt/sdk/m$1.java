  ...
  extends Handler
{
  ...
  public final void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      m.a(lSJ, (Context)arrayOfObject[0], (String)arrayOfObject[1], ((Integer)arrayOfObject[2]).intValue());
      continue;
      r.i("TbsInstaller", "TbsInstaller--handleMessage--MSG_COPY_TBS_CORE");
      arrayOfObject = (Object[])obj;
      m.a(lSJ, (Context)arrayOfObject[0], (Context)arrayOfObject[1], ((Integer)arrayOfObject[2]).intValue());
      continue;
      r.i("TbsInstaller", "TbsInstaller--handleMessage--MSG_INSTALL_TBS_CORE_EX");
      arrayOfObject = (Object[])obj;
      lSJ.d((Context)arrayOfObject[0], (Bundle)arrayOfObject[1]);
    }
  }
}
