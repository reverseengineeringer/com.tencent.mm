...
{
  public static int ig(String paramString)
  {
    if ((paramString == null) || (paramString.length() <= 0))
    {
      u.e("!24@cGB/4jtGxPuGiNjOv8QAsA==", "getStrokesCount buffer is empty");
      return 0;
    }
    for (;;)
    {
      ...
      try
      {
        ...
        u.e("!24@cGB/4jtGxPuGiNjOv8QAsA==", "byteToShort");
        i = 0;
      }
      catch (UnsupportedEncodingException paramString)
      {
        int k;
        u.e("!24@cGB/4jtGxPuGiNjOv8QAsA==", "exception:%s", new Object[] { ay.b(paramString) });
        return 0;
      }
      if (i < 2)
      {
