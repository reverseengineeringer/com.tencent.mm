...
public abstract interface i
  extends IInterface
{
  public abstract void a(p paramp, int paramInt1, int paramInt2, String paramString);
    ...
    implements i
  {
    ...
    public static i Z(IBinder paramIBinder)
    {
    ...
    public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
    {
      ...
      a(p.a.ab(paramParcel1.readStrongBinder()), paramParcel1.readInt(), paramParcel1.readInt(), paramParcel1.readString());
      ...
      implements i
    {
      ...
      /* Error */
      public final void a(p paramp, int paramInt1, int paramInt2, String paramString)
      {
        // Byte code:
        ...
        //   53: aload_0
        //   54: getfield 18	com/tencent/mm/network/i$a$a:mRemote	Landroid/os/IBinder;
        //   57: iconst_1
        //   58: aload 5
        //   60: aload 6
        //   62: iconst_0
