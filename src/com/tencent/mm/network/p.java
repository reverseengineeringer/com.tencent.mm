  ...
  extends IInterface
{
  ...
  public abstract long CH();
  
  public abstract boolean c(u paramu);
  
  public abstract boolean d(u paramu);
    ...
    implements p
  {
    ...
    public static p Y(IBinder paramIBinder)
    {
    ...
    public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
    {
      ...
      case 2: 
        paramParcel1.enforceInterface("com.tencent.mm.network.INetworkEvent_AIDL");
        bool = c(u.a.aa(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        paramInt1 = i;
        if (bool) {
          paramInt1 = 1;
      ...
      case 3: 
        paramParcel1.enforceInterface("com.tencent.mm.network.INetworkEvent_AIDL");
        bool = d(u.a.aa(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        paramInt1 = j;
        if (bool) {
          paramInt1 = 1;
      ...
      implements p
    {
      ...
      public final boolean c(u paramu)
      {
        ...
        //   36: aload_0
        //   37: getfield 18	com/tencent/mm/network/p$a$a:mRemote	Landroid/os/IBinder;
        //   40: iconst_2
        //   41: aload 4
        //   43: aload 5
        //   45: iconst_0
