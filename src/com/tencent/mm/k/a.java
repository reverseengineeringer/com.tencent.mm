    ...
    catch (Exception localException1)
    {
      for (;;)
      {
        try
        {
          ...
          l2 = l1;
          l1 = l4;
          u.i("!32@/B4Tb64lLpJTdx1LqNowoXUlOfngbDfg", "checkRomSparespace available:%d all:%d freeSize :%d", new Object[] { Long.valueOf(l2), Long.valueOf(l3), Long.valueOf(l1) });
        ...
        l1 = 0L;
        u.e("!32@/B4Tb64lLpJTdx1LqNowoXUlOfngbDfg", "get db spare space error");
        l2 = l1;
        l3 = 0L;
        l1 = 0L;
      }
