...
public abstract class ae
{
  ...
  private static Map b(Field[] paramArrayOfField)
  {
    ...
    if (i < paramArrayOfField.length)
    {
      ...
      if (str == null) {
        t.e("!44@/B4Tb64lLpLLUFo2TM7uCbJuPRuarh9/GXNqcjNxYhM=", "failed identify on column: " + ((Field)localObject).getName() + ", skipped");
      }
      for (;;)
      {
        i += 1;
  ...
  private static String c(Field[] paramArrayOfField)
  {
    ...
    if (i < paramArrayOfField.length)
    {
      ...
      if (localObject == null) {
        t.e("!44@/B4Tb64lLpLLUFo2TM7uCbJuPRuarh9/GXNqcjNxYhM=", "failed identify on column: " + localField.getName() + ", skipped");
      }
      do
      {
        i += 1;
      ...
      str1 = " default '" + ((ag)localField.getAnnotation(ag.class)).aFO() + "' ";
    }
    for (int j = ((ag)localField.getAnnotation(ag.class)).aFP();; j = 0)
    {
  ...
  public static Field[] e(Class paramClass)
  {
    ...
    if (i < j)
    {
      ...
      if ((str != null) && (Modifier.isPublic(k)) && (!Modifier.isFinal(k)))
      {
        ...
        if (((ag)localField.getAnnotation(ag.class)).aFP() == 1) {
          ibW = paramClass;
        }
      }
      for (;;)
    ...
    bNX = ((Field[])localLinkedList.toArray(new Field[0]));
    bbY = a(bNX);
    ibX = b(bNX);
    ibY = c(bNX);
    return bNX;
  ...
  public abstract a lX();
  
  public abstract ContentValues mA();
  ...
  public static final class a
  {
    ...
    public String[] bbY;
    public String ibW;
    public Map ibX = new HashMap();
    public String ibY;
  }
}

/* Location:
 * Qualified Name:     com.tencent.mm.sdk.g.ae
