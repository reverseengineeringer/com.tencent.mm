...
{
  public static Bundle Hq(String paramString)
  {
  ...
  public static Bundle Hr(String paramString)
  {
  ...
  public static String M(Bundle paramBundle)
  {
    if (paramBundle == null) {
      return "";
    }
  ...
  public static String b(String paramString1, String paramString2, Bundle paramBundle)
  {
    ...
    if (paramString2.equals("GET")) {
      localObject1 = paramString1 + "?" + M(paramBundle);
    }
    u.d("Facebook-Util", paramString2 + " URL: " + (String)localObject1);
...
/* Location:
 * Qualified Name:     com.tencent.mm.ui.d.a.f
