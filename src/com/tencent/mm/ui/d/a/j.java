...
{
  public static Bundle Bw(String paramString)
  {
  ...
  public static String b(String paramString1, String paramString2, Bundle paramBundle)
  {
    ...
    if (paramString2.equals("GET")) {
      localObject1 = paramString1 + "?" + J(paramBundle);
    }
    t.d("Facebook-Util", paramString2 + " URL: " + (String)localObject1);
    ...
    if (!paramString2.equals("GET"))
    {
      ...
      paramString2.write(c(paramBundle, "3i2ndDfv2rTHiSisAbouNdArYfORhtTPEefj3q2f").getBytes());
    ...
    try
    {
      paramString2 = i(paramString1.getInputStream());
      return paramString2;
    }
    catch (FileNotFoundException paramString2) {}
    return i(paramString1.getErrorStream());
  }
  
  private static String c(Bundle paramBundle, String paramString)
  {
    if (paramBundle == null) {
      return "";
    }
...
/* Location:
 * Qualified Name:     com.tencent.mm.ui.d.a.j
