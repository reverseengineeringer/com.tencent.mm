  ...
  extends aa.b
{
  ...
  public final View a(LayoutInflater paramLayoutInflater, View paramView)
  {
    ...
    {
      localObject = new ax(paramLayoutInflater, 2131361874);
  ...
  public final boolean a(View paramView, ChattingUI.a parama, ag paramag)
  {
    ...
    if (paramView != null)
    {
      ...
      if (!ay.kz(byJ))
      {
        ...
        u.d("!64@/B4Tb64lLpKwUcOR+EdWcmbiHpejF20aQqghUEo2T2uy6TgTnPqaNZVfV+PNzAxg", "onItemClick hasplay, skip");
        paramag = new Intent();
        ...
        com.tencent.mm.ar.c.c(koJ.kpc, "luckymoney", ".ui.LuckyMoneyNewYearReceiveUI", paramag);
      }
    }
    return true;
    label123:
    u.d("!64@/B4Tb64lLpKwUcOR+EdWcmbiHpejF20aQqghUEo2T2uy6TgTnPqaNZVfV+PNzAxg", "onItemClick play egg emoj");
    Intent localIntent = new Intent();
    localIntent.putExtra("key_native_url", byJ);
    localIntent.putExtra("key_username", parama.getTalkerUserName());
    localIntent.putExtra("key_image_id", byM);
    localIntent.putExtra("key_image_aes_key", byN);
    localIntent.putExtra("key_image_length", byO);
    com.tencent.mm.ar.c.c(koJ.kpc, "luckymoney", ".ui.LuckyMoneyNewYearReceiveUI", localIntent);
    byK = 1;
    paramag.setContent(a.a.b(paramView));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramView = q.J(paramView, "msg", null);
        if ((paramView != null) && (paramView.size() > 0)) {
          paramag.co(ap.P(paramView));
        }
      }
      catch (Exception paramView)
      {
        u.e("!64@/B4Tb64lLpKwUcOR+EdWcmbiHpejF20aQqghUEo2T2uy6TgTnPqaNZVfV+PNzAxg", paramView.getMessage());
      }
    }
  }
}
