  ...
  extends cf.c
{
  ...
  public final View a(LayoutInflater paramLayoutInflater, View paramView)
  {
    ...
    {
      localObject = new ds(paramLayoutInflater, a.k.chatting_item_to_video);
      ((View)localObject).setTag(new pd(dJX).f((View)localObject, false));
    }
  ...
  public final void a(cf.a parama, int paramInt, ChattingUI.a parama1, ar paramar, String paramString)
  {
    iUg = parama1;
    parama = (pd)parama;
    pd.a(parama, paramar, false, paramInt, parama1, a.h.chat_img_to_bg_mask);
    if (aOu())
    {
  ...
  public final boolean a(ContextMenu paramContextMenu, View paramView, ar paramar)
  {
    if (ax.tl().isSDCardAvailable())
    {
      ...
      if ((localab != null) && ((status == 199) || (status == 199)))
      {
        ...
        if ((!paramar.aHu()) && (paramar.aHF()) && (aOt()) && ((status == 199) || (status == 199) || (aWT == 1)) && (AV(field_talker))) {
