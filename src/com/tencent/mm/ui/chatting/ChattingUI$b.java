...
public final class ChattingUI$b
{
  public static void a(ListView paramListView, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    t.i("!32@/B4Tb64lLpKwUcOR+EdWcmybqEj/+Vl/", "setSelectionFromTop position %s smooth %s", new Object[] { Integer.valueOf(paramInt1), Boolean.valueOf(paramBoolean) });
  ...
  public static void a(ListView paramListView, int paramInt, boolean paramBoolean)
  {
    ...
    t.i("!32@/B4Tb64lLpKwUcOR+EdWcmybqEj/+Vl/", "setSelection position %s smooth %s", new Object[] { Integer.valueOf(paramInt), Boolean.valueOf(paramBoolean) });
