...
{
  public static final int[] kqH = { 16843087, 16843088, 16843379 };
  public static final int[] kqI = { 16843379 };
  
  public static LayoutInflater a(LayoutInflater paramLayoutInflater)
  {
    a.cY(paramLayoutInflater.getContext());
    paramLayoutInflater = paramLayoutInflater.cloneInContext(paramLayoutInflater.getContext());
    a locala = new a((byte)0);
    kqJ = paramLayoutInflater;
    paramLayoutInflater.setFactory(locala);
    return paramLayoutInflater;
  }
  
  public static LayoutInflater ee(Context paramContext)
  {
    a.cY(paramContext);
