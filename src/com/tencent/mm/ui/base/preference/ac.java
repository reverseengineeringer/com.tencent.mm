...
public final class ac
{
  ...
  private static final Class[] iMR = { Context.class, AttributeSet.class };
  final Object[] iMQ = new Object[2];
  ...
  {
    Object localObject1 = (Constructor)iMP.get(paramString1);
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramString2 != null)
        {
          ...
          localObject2 = ((ClassLoader)localObject3).loadClass((String)localObject2).getConstructor(iMR);
      ...
      try
      {
        iMP.put(paramString1, localObject2);
        localObject1 = localObject2;
        localObject3 = iMQ;
  ...
  void a(XmlPullParser paramXmlPullParser, l paraml, AttributeSet paramAttributeSet)
  {
    ...
    while (((i != 3) || (paramXmlPullParser.getDepth() > j)) && (i != 1)) {
      ...
      {
        paraml.a(a(paramXmlPullParser.getName(), paramAttributeSet), -1);
        i = paramXmlPullParser.next();
      }
    }
  }
