  ...
  extends PopupWindow
{
  ...
  public bl(View paramView, int paramInt1, int paramInt2)
  {
    super(paramView, paramInt1, paramInt2);
    super.setBackgroundDrawable(null);
  }
  
  public bl(View paramView, int paramInt1, int paramInt2, boolean paramBoolean)
  {
  ...
  public void dismiss()
  {
    ...
    {
      t.e("!32@/B4Tb64lLpLKmnl4Jnfl+pqhp+Z26Rpq", "dismiss exception, e = " + localException.getMessage());
    }
  }
    ...
    extends FrameLayout
  {
    ...
    {
      if ((bl.a(bl.this) != null) && (bl.a(bl.this).onTouch(this, paramMotionEvent))) {
        return true;
      }
