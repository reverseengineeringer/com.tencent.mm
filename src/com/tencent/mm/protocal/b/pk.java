  ...
  extends adm
{
  public int hpf;
  public String hpg;
  public LinkedList hzI = new LinkedList();
  public int hzJ;
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      paramVarArgs.d(2, 8, hzI);
      paramVarArgs.bM(3, hzJ);
      paramVarArgs.bM(4, hpf);
      if (hpg != null) {
        paramVarArgs.U(5, hpg);
      }
      return 0;
    }
    if (paramInt == 1) {
    ...
    {
      int i = paramInt + a.a.a.a.c(2, 8, hzI) + a.a.a.a.bI(3, hzJ) + a.a.a.a.bI(4, hpf);
      paramInt = i;
      if (hpg != null) {
        paramInt = i + a.a.a.b.b.a.T(5, hpg);
      }
      return paramInt;
      if (paramInt == 2)
      {
