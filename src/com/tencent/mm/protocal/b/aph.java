  ...
  extends amb
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      paramVarArgs.cw(2, cNm);
      if (cNn != null) {
        paramVarArgs.e(3, cNn);
      }
      if (cNl != null) {
        paramVarArgs.e(4, cNl);
      }
      return 0;
    }
    if (paramInt == 1) {
    ...
    {
      int i = paramInt + a.a.a.a.cu(2, cNm);
      paramInt = i;
      if (cNn != null) {
        paramInt = i + a.a.a.b.b.a.f(3, cNn);
      }
      i = paramInt;
      if (cNl != null) {
        i = paramInt + a.a.a.b.b.a.f(4, cNl);
      }
      return i;
      if (paramInt == 2)
      {
...
/* Location:
 * Qualified Name:     com.tencent.mm.protocal.b.aph
