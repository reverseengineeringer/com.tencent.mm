  ...
  extends adk
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (hmj != null) {
        paramVarArgs.U(3, hmj);
      }
      paramVarArgs.bM(4, hmk);
      return 0;
    }
    if (paramInt == 1) {
      if (hLO == null) {
    ...
    {
      int i = paramInt + a.a.a.a.bI(2, hkO);
      paramInt = i;
      if (hmj != null) {
        paramInt = i + a.a.a.b.b.a.T(3, hmj);
      }
      return paramInt + a.a.a.a.bI(4, hmk);
      if (paramInt == 2)
      {
...
/* Location:
 * Qualified Name:     com.tencent.mm.protocal.b.dm
