  ...
  extends amb
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (jOm != null)
      {
        paramVarArgs.cx(2, jOm.iO());
        jOm.a(paramVarArgs);
      }
      paramVarArgs.cw(3, jNy);
      return 0;
    }
    if (paramInt == 1) {
      if (kfH == null) {
    ...
    for (paramInt = a.a.a.a.cv(1, kfH.iO()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (jOm != null) {
        i = paramInt + a.a.a.a.cv(2, jOm.iO());
      }
      return i + a.a.a.a.cu(3, jNy);
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 2: 
          ...
          while (paramInt < i)
          {
            ...
            localObject2 = new a.a.a.a.a((byte[])localObject2, jrk);
            for (bool = true; bool; bool = ((ake)localObject1).a((a.a.a.a.a)localObject2, (com.tencent.mm.ax.a)localObject1, amb.a((a.a.a.a.a)localObject2))) {}
            jOm = ((ake)localObject1);
            paramInt += 1;
          }
        }
        jNy = mMY.id();
