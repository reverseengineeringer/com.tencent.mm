  ...
  extends alq
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (jtm != null) {
        paramVarArgs.d(4, jtm);
      }
      if (jtp != null)
      {
        paramVarArgs.cj(5, jtp.kn());
        jtp.a(paramVarArgs);
      }
      paramVarArgs.ci(6, jtq);
      return 0;
    }
    if (paramInt == 1) {
      if (jHj == null) {
    ...
    {
      int i = paramInt + a.a.a.a.cg(2, fUi) + a.a.a.a.c(3, 8, jak);
      paramInt = i;
      if (jtm != null) {
        paramInt = i + a.a.a.b.b.a.e(4, jtm);
      }
      i = paramInt;
      if (jtp != null) {
        i = paramInt + a.a.a.a.ch(5, jtp.kn());
      }
      return i + a.a.a.a.cg(6, jtq);
      if (paramInt == 2)
      {
...
/* Location:
 * Qualified Name:     com.tencent.mm.protocal.b.vu
