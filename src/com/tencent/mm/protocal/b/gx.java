  ...
  extends adk
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (hra != null) {
        paramVarArgs.U(7, hra);
      }
      if (hrb != null) {
        paramVarArgs.U(9, hrb);
      }
      paramVarArgs.bM(10, hrc);
      return 0;
    }
    if (paramInt == 1) {
      if (hLO == null) {
    ...
    for (paramInt = a.a.a.a.bJ(1, hLO.kS()) + 0;; paramInt = 0)
    {
      ...
      i = paramInt;
      if (hra != null) {
        i = paramInt + a.a.a.b.b.a.T(7, hra);
      }
      paramInt = i;
      if (hrb != null) {
        paramInt = i + a.a.a.b.b.a.T(9, hrb);
      }
      return paramInt + a.a.a.a.bI(10, hrc);
      if (paramInt == 2)
      {
