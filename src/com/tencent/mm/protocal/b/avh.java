    ...
    for (int i = a.a.a.a.cv(1, kfH.iO()) + 0;; i = 0)
    {
      ...
      if (paramInt == 3)
      {
        ...
        while (paramInt < i)
        {
          ...
          localObject1 = new fd();
          localObject2 = new a.a.a.a.a((byte[])localObject2, jrk);
          for (bool = true; bool; bool = ((fd)localObject1).a((a.a.a.a.a)localObject2, (com.tencent.mm.ax.a)localObject1, amb.a((a.a.a.a.a)localObject2))) {}
          jMb = ((fd)localObject1);
          paramInt += 1;
        }
        break;
...
/* Location:
 * Qualified Name:     com.tencent.mm.protocal.b.avh
