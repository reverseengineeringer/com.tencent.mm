  ...
  extends ali
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (jil != null)
      {
        paramVarArgs.cj(2, jil.kn());
        jil.a(paramVarArgs);
      }
      paramVarArgs.ci(3, jal);
      paramVarArgs.ci(4, jim);
    ...
    for (paramInt = a.a.a.a.ch(1, jGS.kn()) + 0;; paramInt = 0)
    {
      int i = paramInt;
      if (jil != null) {
        i = paramInt + a.a.a.a.ch(2, jil.kn());
      }
      return i + a.a.a.a.cg(3, jal) + a.a.a.a.cg(4, jim) + a.a.a.a.cg(5, dzC);
      if (paramInt == 2)
      {
