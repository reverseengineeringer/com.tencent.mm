  ...
  extends alq
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (jMJ != null) {
        paramVarArgs.d(2, jMJ);
      }
      if (username != null) {
        paramVarArgs.d(3, username);
      }
      return 0;
    }
    if (paramInt == 1) {
    ...
    for (int i = a.a.a.a.ch(1, jHj.kn()) + 0;; i = 0)
    {
      paramInt = i;
      if (jMJ != null) {
        paramInt = i + a.a.a.b.b.a.e(2, jMJ);
      }
      i = paramInt;
      if (username != null) {
        i = paramInt + a.a.a.b.b.a.e(3, username);
      }
      return i;
      if (paramInt == 2)
      {
...
/* Location:
 * Qualified Name:     com.tencent.mm.protocal.b.atv
