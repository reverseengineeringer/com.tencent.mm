  ...
  extends amb
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      paramVarArgs.cw(2, dAH);
      if (dAI != null) {
        paramVarArgs.e(3, dAI);
      }
      if (token != null) {
        paramVarArgs.e(4, token);
      }
      return 0;
    }
    if (paramInt == 1) {
    ...
    {
      int i = paramInt + a.a.a.a.cu(2, dAH);
      paramInt = i;
      if (dAI != null) {
        paramInt = i + a.a.a.b.b.a.f(3, dAI);
      }
      i = paramInt;
      if (token != null) {
        i = paramInt + a.a.a.b.b.a.f(4, token);
      }
      return i;
      if (paramInt == 2)
      {
