  ...
  extends adk
{
  ...
  public int hEI;
  public LinkedList hEJ = new LinkedList();
  public String hst;
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      paramVarArgs.d(4, 8, hEH);
      paramVarArgs.bM(5, hEI);
      paramVarArgs.d(6, 8, hEJ);
      return 0;
    }
    if (paramInt == 1) {
      if (hLO == null) {
    ...
    for (paramInt = a.a.a.a.bJ(1, hLO.kS()) + 0;; paramInt = 0)
    {
      ...
      return i + a.a.a.a.bI(3, hEG) + a.a.a.a.c(4, 8, hEH) + a.a.a.a.bI(5, hEI) + a.a.a.a.c(6, 8, hEJ);
      if (paramInt == 2)
      {
...
/* Location:
 * Qualified Name:     com.tencent.mm.protocal.b.wd
