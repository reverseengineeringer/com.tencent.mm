  ...
  extends adm
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      paramVarArgs.bM(2, cUV);
      if (cUW != null) {
        paramVarArgs.U(3, cUW);
      }
      if (token != null) {
        paramVarArgs.U(4, token);
      }
      return 0;
    }
    if (paramInt == 1) {
    ...
    {
      int i = paramInt + a.a.a.a.bI(2, cUV);
      paramInt = i;
      if (cUW != null) {
        paramInt = i + a.a.a.b.b.a.T(3, cUW);
      }
      i = paramInt;
      if (token != null) {
        i = paramInt + a.a.a.b.b.a.T(4, token);
      }
      return i;
      if (paramInt == 2)
      {
