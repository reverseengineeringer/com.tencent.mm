  ...
  extends alq
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (jJs != null)
      {
        paramVarArgs.cj(2, jJs.kn());
        jJs.a(paramVarArgs);
      }
      if (jJr != null)
      {
        paramVarArgs.cj(3, jJr.kn());
        jJr.a(paramVarArgs);
      }
      return 0;
    }
    ...
    for (int i = a.a.a.a.ch(1, jHj.kn()) + 0;; i = 0)
    {
      paramInt = i;
      if (jJs != null) {
        paramInt = i + a.a.a.a.ch(2, jJs.kn());
      }
      i = paramInt;
      if (jJr != null) {
        i = paramInt + a.a.a.a.ch(3, jJr.kn());
      }
      return i;
      if (paramInt == 2)
      {
...
/* Location:
 * Qualified Name:     com.tencent.mm.protocal.b.aps
