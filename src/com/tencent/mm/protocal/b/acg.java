...
{
  public int cmq;
  public LinkedList<ya> cmr = new LinkedList();
    ...
    for (paramInt = a.a.a.a.cv(1, kfH.iO()) + 0;; paramInt = 0)
    {
      ...
      if (paramInt == 3)
      {
        ...
        while (paramInt < i)
        {
          ...
          localObject1 = new ya();
          localObject2 = new a.a.a.a.a((byte[])localObject2, jrk);
          for (bool = true; bool; bool = ((ya)localObject1).a((a.a.a.a.a)localObject2, (com.tencent.mm.ax.a)localObject1, amb.a((a.a.a.a.a)localObject2))) {}
