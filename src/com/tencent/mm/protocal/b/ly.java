  ...
  extends ali
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    if (paramInt == 0)
    {
      ...
      if (jjY != null) {
        paramVarArgs.d(2, jjY);
      }
      if (iWi != null) {
        paramVarArgs.d(3, iWi);
      }
    ...
    for (int i = a.a.a.a.ch(1, jGS.kn()) + 0;; i = 0)
    {
      paramInt = i;
      if (jjY != null) {
        paramInt = i + a.a.a.b.b.a.e(2, jjY);
      }
      i = paramInt;
      if (iWi != null) {
        i = paramInt + a.a.a.b.b.a.e(3, iWi);
      }
      return i + a.a.a.a.cg(4, fUl);
      if (paramInt == 2)
      {
...
/* Location:
 * Qualified Name:     com.tencent.mm.protocal.b.ly
