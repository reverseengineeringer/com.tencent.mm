...
{
  private static WakerLock bbT = null;
  private static WakerLock bdb = null;
  private static a bdc;
  private static int bdd = 0;
  private static long bde = 0L;
  private static boolean bdf = true;
  private static Object bdg = new Object();
  
  public static void nv()
  {
    com.tencent.mm.sdk.platformtools.t.i("!32@/B4Tb64lLpKcoq2tqqkpMh2WNrKeFFpl", "markUIShow");
    bdf = false;
    aw.CS().edit().putBoolean("is_in_notify_mode", false).commit();
  }
  ...
  {
    com.tencent.mm.sdk.platformtools.t.i("!32@/B4Tb64lLpKcoq2tqqkpMh2WNrKeFFpl", "onReceive");
    if (paramIntent == null) {
      return;
    }
    if (paramContext.getSharedPreferences("system_config_prefs", com.tencent.mm.compatible.util.j.pj()).getBoolean("settings_fully_exit", true))
    {
      com.tencent.mm.sdk.platformtools.t.i("!32@/B4Tb64lLpKcoq2tqqkpMh2WNrKeFFpl", "fully exited, no need to start service");
      return;
    }
