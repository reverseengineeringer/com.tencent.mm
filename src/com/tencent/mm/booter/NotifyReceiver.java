...
{
  private static WakerLock aZr = null;
  private static WakerLock ban = null;
  private static Set<Long> bao = new HashSet();
  private static Lock bap = new ReentrantLock(false);
  private static byte[] baq = new byte[0];
  private static byte[] bar = new byte[0];
  private static a bas;
  private static long bat = 0L;
  ...
  public static void le()
  {
    ...
    bau = false;
    z.Fv().edit().putBoolean("is_in_notify_mode", false).commit();
  }
  ...
  public static void lf()
  {
    ah.tF().b(138, bas);
    ah.tF().b(39, bas);
    ah.tF().b(268369922, bas);
    if (bas == null) {
      bas = new a();
    }
    ah.tF().a(138, bas);
    ah.tF().a(39, bas);
    ah.tF().a(268369922, bas);
  }
    ...
    extends Service
  {
        ...
        if (baw.booleanValue())
        {
          ...
          for (i = -1;; i = localObject1.length)
          {
            ...
            case 10: 
              ...
              paramIntent = new o.b();
              deviceID = p.mN();
              localObject2 = new com.tencent.mm.t.s(paramIntent, 10);
              try
              {
                if (!((com.tencent.mm.t.s)localObject2).a(10, (byte[])localObject1, null)) {
                  break label11;
                }
                ah.tF().onSceneEnd(0, 0, "", new com.tencent.mm.modelsimple.j(paramIntent));
                return;
              }
          ...
          try
          {
            ...
            com.tencent.mm.modelmulti.k.a(i, paramIntent, (byte[])localObject2, l);
    ...
    private static void y(byte[] paramArrayOfByte)
    {
      ...
      com.tencent.mm.sdk.c.a.kug.y(localgg);
    }
