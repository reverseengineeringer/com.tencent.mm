...
{
  public static final Parcelable.Creator<BindWordingContent> CREATOR = new Parcelable.Creator() {};
  public Integer bUo = Integer.valueOf(0);
  ...
  public BindWordingContent(Parcel paramParcel)
  {
    ...
    bUo = Integer.valueOf(paramParcel.readInt());
  }
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    paramParcel.writeInt(bUo.intValue());
  }
}
