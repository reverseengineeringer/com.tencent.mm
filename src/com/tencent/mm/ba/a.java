...
{
  public static final String kiO = g.getExternalStorageDirectory() + "/tencent/MicroMsg/memory/";
  ...
  public static String Gc(String paramString)
  {
    ...
    ((StringBuffer)localObject).append(kiO).append(paramString).append(".hprof");
    ...
    try
    {
      ...
      Toast.makeText(y.getContext(), (String)localObject + " hprof file has saved ", 0).show();
      u.i("!44@/B4Tb64lLpI67oPDTT86rGpV5UYBJBo2TPukf7fPbzI=", "dump file %s, use time %d", new Object[] { paramString, Long.valueOf(ay.an(l)) });
      paramString = new File((String)localObject);
      if (!paramString.exists())
      {
        u.e("!44@/B4Tb64lLpI67oPDTT86rGpV5UYBJBo2TPukf7fPbzI=", "Hprof dump file is not exist");
        return null;
      }
    }
    catch (IOException paramString)
    {
      u.e("!44@/B4Tb64lLpI67oPDTT86rGpV5UYBJBo2TPukf7fPbzI=", " dumpHprofFile IOException");
      return null;
    }
    paramString = p.a(paramString, true, null);
    if (paramString == null)
    {
      u.e("!44@/B4Tb64lLpI67oPDTT86rGpV5UYBJBo2TPukf7fPbzI=", "zip hprof file fail");
      return null;
    }
    return paramString;
  }
  ...
  private static boolean aZd()
  {
    if (!g.oW())
    {
      u.i("!44@/B4Tb64lLpI67oPDTT86rGpV5UYBJBo2TPukf7fPbzI=", "Hprof sdcard is invalid");
      return false;
    }
    File localFile = new File(kiO);
    if (!localFile.exists()) {
      localFile.mkdirs();
    }
    return true;
  ...
  public static void aZe()
  {
    ...
    {
      Object localObject1 = (ActivityManager)y.getContext().getSystemService("activity");
      u.i("!44@/B4Tb64lLpI67oPDTT86rGpV5UYBJBo2TPukf7fPbzI=", " wechat heap info ");
      u.i("!44@/B4Tb64lLpI67oPDTT86rGpV5UYBJBo2TPukf7fPbzI=", " Runtime.totalMemory " + Runtime.getRuntime().totalMemory());
      u.i("!44@/B4Tb64lLpI67oPDTT86rGpV5UYBJBo2TPukf7fPbzI=", " Runtime.freeMemory " + Runtime.getRuntime().freeMemory());
      u.i("!44@/B4Tb64lLpI67oPDTT86rGpV5UYBJBo2TPukf7fPbzI=", " Runtime.maxMemory " + Runtime.getRuntime().maxMemory());
      u.i("!44@/B4Tb64lLpI67oPDTT86rGpV5UYBJBo2TPukf7fPbzI=", " Debug.nativeHeapSize " + Debug.getNativeHeapSize());
      u.i("!44@/B4Tb64lLpI67oPDTT86rGpV5UYBJBo2TPukf7fPbzI=", " Debug.nativeHeapAllocatedSize " + Debug.getNativeHeapAllocatedSize());
      ...
      while (i < j)
      {
        ...
        u.i("!44@/B4Tb64lLpI67oPDTT86rGpV5UYBJBo2TPukf7fPbzI=", " wechat memory info");
        u.i("!44@/B4Tb64lLpI67oPDTT86rGpV5UYBJBo2TPukf7fPbzI=", " pidMemoryInfo.getTotalPrivateDirty(): " + ((Debug.MemoryInfo)localObject2).getTotalPrivateDirty() + "\n");
        u.i("!44@/B4Tb64lLpI67oPDTT86rGpV5UYBJBo2TPukf7fPbzI=", " pidMemoryInfo.getTotalPss(): " + ((Debug.MemoryInfo)localObject2).getTotalPss() + "\n");
        u.i("!44@/B4Tb64lLpI67oPDTT86rGpV5UYBJBo2TPukf7fPbzI=", " pidMemoryInfo.getTotalSharedDirty(): " + ((Debug.MemoryInfo)localObject2).getTotalSharedDirty() + "\n");
        i += 1;
      }
    }
    aZf();
  ...
  private static void aZf()
  {
    ...
    //   70: ldc 86
    //   72: aload_1
    //   73: invokestatic 136	com/tencent/mm/sdk/platformtools/u:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   76: goto -15 -> 61
    //   79: astore_1
    //   80: aload_0
    //   81: astore_1
    ...
    //   84: ldc 86
    //   86: ldc_w 259
    //   89: invokestatic 119	com/tencent/mm/sdk/platformtools/u:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   92: aload_0
    //   93: ifnull +7 -> 100
    //   96: aload_0
    ...
    //   139: ldc 86
    //   141: ldc_w 271
    //   144: invokestatic 119	com/tencent/mm/sdk/platformtools/u:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   147: aload_1
    //   148: ifnull +7 -> 155
    //   151: aload_1
  ...
  private static boolean y(boolean paramBoolean1, boolean paramBoolean2)
  {
    boolean bool1;
    if (!aZd()) {
      bool1 = false;
    ...
    do
    {
      ...
      if (i < j)
      {
        ...
        for (;;)
        {
          ...
          {
            u.e("!44@/B4Tb64lLpI67oPDTT86rGpV5UYBJBo2TPukf7fPbzI=", "hprofFileCheck parse date fail %s", new Object[] { str });
            localFile.delete();
            boolean bool2 = bool1;
            continue;
    ...
    if (paramBoolean2) {
      Toast.makeText(y.getContext(), "dump fail, hprof file size exceed", 0).show();
    }
    u.w("!44@/B4Tb64lLpI67oPDTT86rGpV5UYBJBo2TPukf7fPbzI=", "hprofFileCheck hprofFileDir.length() too large " + localObject.length);
    return false;
  }
  
  public static String z(boolean paramBoolean1, boolean paramBoolean2)
  {
    if (!y(paramBoolean1, paramBoolean2)) {
      return null;
    }
    long l = System.currentTimeMillis();
    String str = new SimpleDateFormat("yyyy_MM_dd_HH_mm_ss").format(new Date());
    Object localObject = new StringBuffer();
    ((StringBuffer)localObject).append(kiO).append(str).append(".hprof");
    localObject = ((StringBuffer)localObject).toString();
    try
    {
      System.gc();
      ...
      u.i("!44@/B4Tb64lLpI67oPDTT86rGpV5UYBJBo2TPukf7fPbzI=", "dump file %s, use time %d", new Object[] { str, Long.valueOf(ay.an(l)) });
