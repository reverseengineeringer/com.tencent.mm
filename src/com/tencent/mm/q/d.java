...
{
  private static int bDW = 150;
  private static int bDX = 150;
  static final Map bDY;
  private static a bEc = new a(bDX);
  private com.tencent.mm.sdk.h.h bDZ = new com.tencent.mm.sdk.h.h() {};
  private Vector bEa = new Vector();
  private final a bEb = new a()
  {
    public final void fZ(String paramAnonymousString)
    {
      Vector localVector2 = new Vector();
      u.d("!32@/B4Tb64lLpJO3ngf+FD8EfYnsqwOArnz", "notifyChanged user:%s clonesize:%d watchers:%d", new Object[] { paramAnonymousString, Integer.valueOf(d.a(d.this).size()), Integer.valueOf(d.a(d.this).size()) });
      ...
      for (;;)
      {
        ...
        {
          ((d.a)localVector3.get(i)).fZ(paramAnonymousString);
          i += 1;
        }
        return;
        label203:
  ...
  static
  {
    ...
    bDY = localHashMap;
    localHashMap.put("voipapp", Integer.valueOf(2130903640));
    bDY.put("qqmail", Integer.valueOf(2130903654));
    bDY.put("fmessage", Integer.valueOf(2130903651));
    bDY.put("qmessage", Integer.valueOf(2130903636));
    bDY.put("qqsync", Integer.valueOf(2130903653));
    bDY.put("floatbottle", Integer.valueOf(2130903643));
    bDY.put("lbsapp", Integer.valueOf(2130903659));
    bDY.put("shakeapp", Integer.valueOf(2130903639));
    bDY.put("medianote", Integer.valueOf(2130903638));
    bDY.put("qqfriend", Integer.valueOf(2130903646));
    bDY.put("masssendapp", Integer.valueOf(2130903641));
    bDY.put("feedsapp", Integer.valueOf(2130903644));
    bDY.put("facebookapp", Integer.valueOf(2130903642));
    bDY.put("newsapp", Integer.valueOf(2130903657));
    bDY.put("helper_entry", Integer.valueOf(2130903635));
    bDY.put("voicevoipapp", Integer.valueOf(2130903637));
    bDY.put("voiceinputapp", Integer.valueOf(2130903649));
    bDY.put("officialaccounts", Integer.valueOf(2130903648));
    bDY.put("service_officialaccounts", Integer.valueOf(2130903647));
    bDY.put("googlecontact", Integer.valueOf(2130903645));
    bDY.put("linkedinplugin", Integer.valueOf(2130903655));
    bDY.put("notifymessage", Integer.valueOf(2130903658));
  }
  ...
  public static void a(Context paramContext, ImageView paramImageView, int paramInt)
  {
    ...
    {
      u.e("!32@/B4Tb64lLpJO3ngf+FD8EfYnsqwOArnz", "exception:%s", new Object[] { ay.b(paramContext) });
    }
  }
  
  private WeakReference c(a parama)
  {
    Vector localVector = bEa;
    int i = 0;
    for (;;)
    {
      try
      {
        if (i < bEa.size())
        {
          WeakReference localWeakReference = (WeakReference)bEa.get(i);
          if (localWeakReference != null)
          {
  ...
  private static boolean d(Bitmap paramBitmap)
  {
  ...
  public static Bitmap f(String paramString, byte[] paramArrayOfByte)
  {
    ...
    //   1: bipush 96
    //   3: bipush 96
    //   5: invokestatic 225	com/tencent/mm/sdk/platformtools/d:decodeByteArray	([BII)Landroid/graphics/Bitmap;
    //   8: astore 4
    //   10: aload 4
    //   12: invokestatic 227	com/tencent/mm/q/d:d	(Landroid/graphics/Bitmap;)Z
    //   15: ifne +20 -> 35
    //   18: ldc -79
    //   20: ldc -27
    //   22: iconst_1
    ...
    //   28: aload_0
    //   29: aastore
    //   30: invokestatic 190	com/tencent/mm/sdk/platformtools/u:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   33: aconst_null
    //   34: areturn
    //   35: aload_0
    //   36: iconst_0
    //   37: invokestatic 233	com/tencent/mm/q/d:k	(Ljava/lang/String;Z)Ljava/lang/String;
    //   40: astore_2
    //   41: aload_2
    //   42: invokestatic 239	com/tencent/mm/modelsfs/FileOp:iI	(Ljava/lang/String;)Ljava/io/OutputStream;
    //   45: astore_3
    //   46: aload_3
    //   47: astore_2
    //   48: aload_3
    ...
    //   51: aload_1
    //   52: arraylength
    //   53: invokevirtual 245	java/io/OutputStream:write	([BII)V
    //   56: aload_3
    //   57: ifnull +7 -> 64
    //   60: aload_3
    //   61: invokevirtual 248	java/io/OutputStream:close	()V
    //   64: ldc -79
    //   66: ldc -6
    //   68: iconst_1
    ...
    //   74: aload_0
    //   75: aastore
    //   76: invokestatic 253	com/tencent/mm/sdk/platformtools/u:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   79: aload 4
    //   81: areturn
    //   82: astore_1
    //   83: aconst_null
    ...
    //   98: aload_0
    //   99: aastore
    //   100: invokestatic 259	com/tencent/mm/sdk/platformtools/u:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   103: aload_3
    //   104: ifnull -71 -> 33
    //   107: aload_3
    //   108: invokevirtual 248	java/io/OutputStream:close	()V
    //   111: aconst_null
    //   112: areturn
    //   113: astore_0
    //   114: aconst_null
    ...
    //   120: ifnull +7 -> 127
    //   123: aload_2
    //   124: invokevirtual 248	java/io/OutputStream:close	()V
    //   127: aload_0
    //   128: athrow
    //   129: astore_1
    //   130: goto -66 -> 64
  ...
  public static Bitmap fU(String paramString)
  {
    ...
    do
    {
      ...
      localObject1 = bEc;
      if (bDD != null) {}
      for (localObject1 = (Bitmap)bDD.get(paramString); localObject1 == null; localObject1 = (Bitmap)a.a.u("avatar_cache", paramString)) {
        return null;
      }
      localObject2 = localObject1;
    } while (!((Bitmap)localObject1).isRecycled());
    Object localObject1 = bEc;
    if (bDD != null) {
      bDD.remove(paramString);
    }
    for (;;)
    {
      return null;
      a.a.x("avatar_cache", paramString);
    }
  }
  
  public static Bitmap fV(String paramString)
  {
    return fY(k(paramString, false));
  }
  
  public static Bitmap fW(String paramString)
  {
    u.d("!32@/B4Tb64lLpJO3ngf+FD8EfYnsqwOArnz", "getHDBitmap user:%s", new Object[] { paramString });
    if (ay.kz(paramString)) {
      return null;
    }
    return com.tencent.mm.sdk.platformtools.d.v(k(paramString, true), 480, 480);
  }
  
  public static Bitmap fX(String paramString)
  {
    int i = 0;
    if (bDY.containsKey(paramString)) {
      i = ((Integer)bDY.get(paramString)).intValue();
    }
    if (i != 0) {
      n.vr();
    }
  ...
  public static Bitmap fY(String paramString)
  {
  ...
  public static String k(String paramString, boolean paramBoolean)
  {
    ...
    String str2 = ah.tD().rz();
    StringBuilder localStringBuilder = new StringBuilder("user_");
    if (paramBoolean) {}
    for (String str1 = "hd_";; str1 = "")
    {
      paramString = com.tencent.mm.sdk.platformtools.h.a(str2, str1, g.m(paramString.getBytes()), ".png", 1, false);
      if (!FileOp.iO(str2)) {
        break;
      }
      return paramString;
  ...
  {
    String str = k(paramString, paramBoolean);
    u.i("!32@/B4Tb64lLpJO3ngf+FD8EfYnsqwOArnz", "Removed avatar: %s, hd: %b, path: %s", new Object[] { paramString, Boolean.valueOf(paramBoolean), str });
    boolean bool2 = FileOp.deleteFile(str);
    boolean bool1 = bool2;
    if (!paramBoolean) {
      bool1 = bool2 | b.cM(str);
    }
    return bool1;
  }
  ...
  public final boolean M(String paramString1, String paramString2)
  {
    try
    {
      Object localObject = com.tencent.mm.sdk.platformtools.d.CB(paramString1);
      int i1 = outWidth;
      int i2 = outHeight;
      int i = 1;
      int m;
      ...
      if (i2 > i1)
      {
        ...
        u.d("!32@/B4Tb64lLpJO3ngf+FD8EfYnsqwOArnz", "inJustDecodeBounds old [w:%d h:%d]  new [w:%d h:%d] corner:%d", new Object[] { Integer.valueOf(i1), Integer.valueOf(i2), Integer.valueOf(k), Integer.valueOf(j), Integer.valueOf(i) });
      ...
      for (float f1 = 1.0F;; f1 = Math.min(96.0F / i, 96.0F / j))
      {
        ...
        u.i("!32@/B4Tb64lLpJO3ngf+FD8EfYnsqwOArnz", "recycle bitmap:%s", new Object[] { paramString1.toString() });
    ...
    {
      u.e("!32@/B4Tb64lLpJO3ngf+FD8EfYnsqwOArnz", "exception:%s", new Object[] { ay.b(paramString1) });
    }
  }
  ...
  public final void a(a parama)
  {
    synchronized (bEa)
    {
      bEa.add(new WeakReference(parama));
      return;
    }
  }
  
  public final Bitmap aJ(Context paramContext)
  {
    paramContext.getResources();
    Bitmap localBitmap = fU("I_AM_NO_SDCARD_USER_NAME");
    ...
    if (!d(localBitmap))
    {
      ...
      if (localBitmap != null)
      {
        u.i("!32@/B4Tb64lLpJO3ngf+FD8EfYnsqwOArnz", "not cached, recycled=%b, reload=%s", new Object[] { Boolean.valueOf(localBitmap.isRecycled()), "I_AM_NO_SDCARD_USER_NAME" });
  ...
  public final void b(String paramString, Bitmap paramBitmap)
  {
    a locala = bEc;
    if (bDD != null) {
      bDD.d(paramString, paramBitmap);
    }
    for (;;)
    {
      bDZ.aw(paramString);
      bDZ.Ep();
      u.d("!32@/B4Tb64lLpJO3ngf+FD8EfYnsqwOArnz", "setToCache %s", new Object[] { paramString });
      return;
  ...
  boolean c(String paramString, Bitmap paramBitmap)
  {
    // Byte code:
    //   0: aload_2
    //   1: invokestatic 227	com/tencent/mm/q/d:d	(Landroid/graphics/Bitmap;)Z
    //   4: ifne +5 -> 9
    //   7: iconst_0
    //   8: ireturn
    //   9: aload_2
    ...
    //   54: iconst_0
    //   55: aload_2
    //   56: invokevirtual 469	java/lang/Object:toString	()Ljava/lang/String;
    //   59: aastore
    //   60: invokestatic 253	com/tencent/mm/sdk/platformtools/u:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   63: aload_2
    //   64: invokevirtual 472	android/graphics/Bitmap:recycle	()V
    //   67: aload_3
    //   68: astore 4
    //   70: aload_1
    //   71: iconst_0
    //   72: invokestatic 233	com/tencent/mm/q/d:k	(Ljava/lang/String;Z)Ljava/lang/String;
    //   75: astore_2
    //   76: aload_2
    //   77: invokestatic 239	com/tencent/mm/modelsfs/FileOp:iI	(Ljava/lang/String;)Ljava/io/OutputStream;
    //   80: astore_2
    //   81: aload 4
    //   83: getstatic 523	android/graphics/Bitmap$CompressFormat:PNG	Landroid/graphics/Bitmap$CompressFormat;
    //   86: bipush 100
    //   88: aload_2
    //   89: invokevirtual 527	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   92: pop
    //   93: aload_2
    //   94: ifnull +7 -> 101
    //   97: aload_2
    //   98: invokevirtual 248	java/io/OutputStream:close	()V
    //   101: aload_0
    //   102: aload_1
    //   103: aload 4
    //   105: invokevirtual 497	com/tencent/mm/q/d:b	(Ljava/lang/String;Landroid/graphics/Bitmap;)V
    //   108: iconst_1
    //   109: ireturn
    //   110: aload_2
    //   111: bipush 96
    //   113: bipush 96
    //   115: iconst_1
    //   116: invokestatic 531	android/graphics/Bitmap:createScaledBitmap	(Landroid/graphics/Bitmap;IIZ)Landroid/graphics/Bitmap;
    //   119: astore_3
    //   120: goto -91 -> 29
    //   123: astore_3
    //   124: ldc -79
    ...
    //   135: aload_1
    //   136: aastore
    //   137: invokestatic 190	com/tencent/mm/sdk/platformtools/u:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   140: aload_2
    //   141: invokestatic 227	com/tencent/mm/q/d:d	(Landroid/graphics/Bitmap;)Z
    //   144: ifeq +26 -> 170
    //   147: ldc -79
    //   149: ldc_w 468
    //   152: iconst_1
    ...
    //   157: iconst_0
    //   158: aload_2
    //   159: invokevirtual 469	java/lang/Object:toString	()Ljava/lang/String;
    //   162: aastore
    //   163: invokestatic 253	com/tencent/mm/sdk/platformtools/u:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   166: aload_2
    //   167: invokevirtual 472	android/graphics/Bitmap:recycle	()V
    //   170: iconst_0
    //   171: ireturn
    //   172: astore_3
    //   173: aconst_null
    ...
    //   186: aload_1
    //   187: aastore
    //   188: invokestatic 259	com/tencent/mm/sdk/platformtools/u:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   191: aload_2
    //   192: ifnull +7 -> 199
    //   195: aload_2
    //   196: invokevirtual 248	java/io/OutputStream:close	()V
    //   199: iconst_0
    //   200: ireturn
    //   201: astore_1
    //   202: aconst_null
    ...
    //   205: ifnull +7 -> 212
    //   208: aload_2
    //   209: invokevirtual 248	java/io/OutputStream:close	()V
    //   212: aload_1
    //   213: athrow
    //   214: astore_2
    //   215: goto -114 -> 101
  ...
  {
    bDZ.a(parama, Looper.getMainLooper());
  }
  ...
  public static final class b
  {
    ...
    /* Error */
    public static Bitmap gb(String paramString)
    {
      // Byte code:
