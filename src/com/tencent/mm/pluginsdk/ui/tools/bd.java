...
{
  private static ax bVf = null;
  
  public static void a(Context paramContext, String paramString1, String paramString2, boolean paramBoolean, a parama)
  {
    if (bVf == null) {
      bVf = new ax(1, "webview-save-image", 1);
    }
    bVf.c(new b(paramContext, paramString1, paramString2, paramBoolean, 1, parama));
  }
  
  public static void a(WebView paramWebView)
  {
    t.d("!32@/B4Tb64lLpJLnjolkGdCeaEhhwktoazg", "initIFrame");
  ...
  {
    if ((paramWebView == null) || (bn.iW(paramString1)) || (bn.iW(paramString2)))
    {
      t.e("!32@/B4Tb64lLpJLnjolkGdCeaEhhwktoazg", "getJsResult fail, invalid argument, scheme = %s, jsCode = %s", new Object[] { paramString1, paramString2 });
      return;
    }
    t.d("!32@/B4Tb64lLpJLnjolkGdCeaEhhwktoazg", "getJsResult, scheme = %s, jsCode = %s", new Object[] { paramString1, paramString2 });
    a(paramWebView);
  ...
  {
    Object localObject = "!32@/B4Tb64lLpJLnjolkGdCeaEhhwktoazg, appendUserAgent fail, context is null, stack = " + bn.aFH();
    boolean bool;
    ...
    {
      localObject = af(paramContext, aa.getPackageName());
      ...
      paramString = al.cO(aa.getContext());
      paramContext = paramContext + " NetType/" + paramString;
      paramContext = paramContext + " Language/" + s.cL(aa.getContext());
      t.d("!32@/B4Tb64lLpJLnjolkGdCeaEhhwktoazg", "appendUserAgent, uaStr = " + paramContext);
      return paramContext;
      bool = false;
      break;
    }
  ...
  public static PackageInfo af(Context paramContext, String paramString)
  {
    if (paramString == null)
    {
      t.e("!32@/B4Tb64lLpJLnjolkGdCeaEhhwktoazg", "getPackageInfo fail, packageName is null");
      return null;
    }
    try
    {
  ...
  public static void b(Context paramContext, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    bVf.c(new b(paramContext, paramString1, paramString2, paramBoolean));
  }
  ...
  public static String bo(String paramString1, String paramString2)
  {
    ...
    {
      t.e("!32@/B4Tb64lLpJLnjolkGdCeaEhhwktoazg", "genJsCode fail, invalid argument, scheme = %s, jsCode = %s", new Object[] { paramString1, paramString2 });
      return null;
    }
    t.d("!32@/B4Tb64lLpJLnjolkGdCeaEhhwktoazg", "genJsCode, scheme = %s, jsCode = %s", new Object[] { paramString1, paramString2 });
    return "document.getElementById('_edw_iframe_').src = '" + paramString1 + "' + " + paramString2;
  }
  
  public static final String vA(String paramString)
  {
    ...
    {
      t.e("!32@/B4Tb64lLpJLnjolkGdCeaEhhwktoazg", "URLEncode fail, throw : %s", new Object[] { localUnsupportedEncodingException.getMessage() });
    }
    return paramString;
  }
  
  public static final String vB(String paramString)
  {
    ...
    catch (UnsupportedEncodingException localUnsupportedEncodingException)
    {
      for (;;)
      {
        ...
        t.e("!32@/B4Tb64lLpJLnjolkGdCeaEhhwktoazg", "getBytes fail, throw : %s", new Object[] { localUnsupportedEncodingException.getMessage() });
      }
    }
  ...
  public static final String x(Map paramMap)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((!bn.iW(str)) && (localObject != null) && ((!(localObject instanceof String)) || (!bn.iW((String)localObject))))
      {
    ...
    implements ax.a
  {
    ...
    public b(Context paramContext, String paramString1, String paramString2, boolean paramBoolean, int paramInt, bd.a parama)
    {
