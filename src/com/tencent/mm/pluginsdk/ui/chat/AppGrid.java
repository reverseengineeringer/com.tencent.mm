  ...
  extends GridView
{
  ...
  Context context;
  AdapterView.OnItemLongClickListener dTS = new AdapterView.OnItemLongClickListener()
  {
    public final boolean onItemLongClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
    {
      paramAnonymousAdapterView = AppGrid.c(AppGrid.this);
      int i = AppGrid.c(AppGrid.this).qg(AppGrid.a(AppGrid.this) * AppGrid.b(AppGrid.this) + paramAnonymousInt);
      AppGrid.d(AppGrid.this).nH(paramAnonymousInt);
      paramAnonymousAdapterView.qh(i);
      return true;
    }
  };
  AdapterView.OnItemClickListener dbs = new AdapterView.OnItemClickListener()
  {
    public final void onItemClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
    {
      AppGrid.c(AppGrid.this).a(AppGrid.c(AppGrid.this).qg(AppGrid.a(AppGrid.this) * AppGrid.b(AppGrid.this) + paramAnonymousInt), AppGrid.d(AppGrid.this).nH(paramAnonymousInt));
    }
  };
  b jgr;
  int jgs;
    ...
    extends BaseAdapter
  {
    ...
    private void a(a parama, String paramString)
    {
      ...
      for (paramString = g.b(field_appId, 4, a.getDensity(AppGrid.h(AppGrid.this)));; paramString = null)
      {
        ...
        for (;;)
        {
          erW.setText(g.a(AppGrid.h(AppGrid.this), localf, null));
          if ((!localf.aUk()) || (!localf.aUl())) {
            break;
          }
          if (AppGrid.i(AppGrid.this) == null) {
            AppGrid.a(AppGrid.this, AppGrid.h(AppGrid.this).getSharedPreferences(aa.aZO(), 0));
          }
    ...
    {
      if (((paramInt < AppGrid.g(AppGrid.this)) && (AppGrid.a(AppGrid.this) == 0)) || (AppGrid.a(AppGrid.this) * AppGrid.b(AppGrid.this) + paramInt < AppGrid.g(AppGrid.this)) || (paramInt - AppGrid.g(AppGrid.this) + AppGrid.a(AppGrid.this) * AppGrid.b(AppGrid.this) >= jgz.size())) {
        return null;
      }
