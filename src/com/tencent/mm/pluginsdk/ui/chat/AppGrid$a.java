  ...
  extends BaseAdapter
{
  ...
  private void a(a parama, String paramString)
  {
    ...
    label230:
    for (paramString = i.b(field_appId, 4, a.getDensity(AppGrid.h(gTt)));; paramString = null)
    {
      if (paramString != null) {
      ...
      for (;;)
      {
        dvz.setText(i.a(AppGrid.h(gTt), localh, null));
        if ((!localh.ayX()) || (!localh.ayY())) {
          break;
        }
        if (AppGrid.i(gTt) == null) {
          AppGrid.a(gTt, AppGrid.h(gTt).getSharedPreferences(aa.aES(), 0));
        }
        if (!AppGrid.i(gTt).getBoolean("SP_KEY_SERVICE_APP_PREFIX_" + field_appId, true)) {
          break;
        }
        gTy.setVisibility(0);
        return;
  ...
  {
    if (AppGrid.a(gTt) == AppGrid.e(gTt) - 1) {
      return AppGrid.f(gTt) - AppGrid.a(gTt) * AppGrid.b(gTt);
    }
    return AppGrid.b(gTt);
  }
  ...
  {
    if (((paramInt < AppGrid.g(gTt)) && (AppGrid.a(gTt) == 0)) || (AppGrid.a(gTt) * AppGrid.b(gTt) + paramInt < AppGrid.g(gTt)) || (paramInt - AppGrid.g(gTt) + AppGrid.a(gTt) * AppGrid.b(gTt) >= gTu.size())) {
      return null;
    }
    paramInt = paramInt - AppGrid.g(gTt) + AppGrid.a(gTt) * AppGrid.b(gTt);
