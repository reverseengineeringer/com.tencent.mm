  ...
  implements Runnable
{
  ...
  public LyricView$c(LyricView paramLyricView, long paramLong)
  {
    ...
    gWN.setTextSize(a.fromDPToPix(paramLyricView.getContext(), 18));
    ...
    gWO.setTextSize(a.fromDPToPix(paramLyricView.getContext(), 18));
    gWO.setShadowLayer(dMu, gWR, gWS, shadowColor);
    paramLyricView = new Rect();
    gWN.getTextBounds("calculate text height", 0, 1, paramLyricView);
    gWP = paramLyricView.height();
    gWQ = (gWP * 4);
  }
