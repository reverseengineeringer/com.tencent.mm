...
public final class l
{
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (localObject != null)
        {
          ...
          localObject = bh(n, j);
          continue;
          localObject = bh(hour, j);
          continue;
          localObject = bh(minute, j);
          continue;
          k = month;
          if (j >= 4)
          {
          ...
          {
            localObject = bh(k + 1, j);
            continue;
            localObject = bh(second, j);
            continue;
            ...
            if (j < 2)
            {
              ...
              for (;;)
              {
                k = (int)(l / 3600L);
                n = (int)(l % 3600L / 60L);
                ((StringBuilder)localObject).append(bh(k, 2));
                ((StringBuilder)localObject).append(bh(n, 2));
  ...
  private static String bh(int paramInt1, int paramInt2)
  {
...
/* Location:
 * Qualified Name:     com.tencent.mm.pluginsdk.g.l
