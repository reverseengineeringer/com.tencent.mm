...
public final class a
{
  ...
  public static byte[] Au(String paramString)
  {
    ...
    //   44: astore_3
    //   45: aload_0
    //   46: invokestatic 53	com/tencent/mm/pluginsdk/i/a/d/a:d	(Ljava/io/Closeable;)V
    //   49: aload_2
    //   50: invokestatic 53	com/tencent/mm/pluginsdk/i/a/d/a:d	(Ljava/io/Closeable;)V
    //   53: aconst_null
    //   54: areturn
    //   55: aload_2
    ...
    //   63: astore_3
    //   64: aload_0
    //   65: invokestatic 53	com/tencent/mm/pluginsdk/i/a/d/a:d	(Ljava/io/Closeable;)V
    //   68: aload_2
    //   69: invokestatic 53	com/tencent/mm/pluginsdk/i/a/d/a:d	(Ljava/io/Closeable;)V
    //   72: aload_3
    //   73: areturn
    //   74: astore_0
    //   75: aconst_null
    ...
    //   78: astore_0
    //   79: aload_0
    //   80: invokestatic 53	com/tencent/mm/pluginsdk/i/a/d/a:d	(Ljava/io/Closeable;)V
    //   83: aload_2
    //   84: invokestatic 53	com/tencent/mm/pluginsdk/i/a/d/a:d	(Ljava/io/Closeable;)V
    //   87: aconst_null
    //   88: areturn
    //   89: astore_3
    //   90: aconst_null
    ...
    //   93: astore_2
    //   94: aload_0
    //   95: invokestatic 53	com/tencent/mm/pluginsdk/i/a/d/a:d	(Ljava/io/Closeable;)V
    //   98: aload_2
    //   99: invokestatic 53	com/tencent/mm/pluginsdk/i/a/d/a:d	(Ljava/io/Closeable;)V
    //   102: aload_3
    //   103: athrow
    //   104: astore_3
    //   105: aconst_null
  ...
  public static void d(Closeable paramCloseable)
  {
    ...
    {
      u.e("!44@/B4Tb64lLpKXg3tSitMNG8utRitGGqpO3DeCdOb69Rs=", String.format("%s close failed (%s)", new Object[] { paramCloseable.getClass().getSimpleName(), localIOException.getMessage() }));
    }
  }
  ...
  public static boolean t(String paramString, byte[] paramArrayOfByte)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokestatic 118	com/tencent/mm/sdk/platformtools/ay:J	([B)Z
    //   4: ifeq +5 -> 9
    //   7: iconst_0
    //   8: ireturn
    ...
    //   22: pop
    //   23: aload_0
    //   24: invokevirtual 122	java/io/File:getParentFile	()Ljava/io/File;
    //   27: invokevirtual 125	java/io/File:mkdirs	()Z
    //   30: pop
    //   31: aconst_null
    //   32: astore_3
    //   33: aconst_null
    //   34: astore_2
    //   35: new 127	java/io/FileOutputStream
    //   38: dup
    //   39: aload_0
    //   40: invokespecial 129	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   43: astore_0
    //   44: aload_0
    //   45: aload_1
    //   46: invokevirtual 132	java/io/FileOutputStream:write	([B)V
    //   49: aload_0
    //   50: invokevirtual 133	java/io/FileOutputStream:flush	()V
    //   53: aload_0
    //   54: invokevirtual 134	java/io/FileOutputStream:close	()V
    //   57: iconst_1
    //   58: ireturn
    //   59: astore_0
    //   60: aconst_null
    ...
    //   63: ifnull -56 -> 7
    //   66: aload_0
    //   67: invokevirtual 133	java/io/FileOutputStream:flush	()V
    //   70: aload_0
    //   71: invokevirtual 134	java/io/FileOutputStream:close	()V
    //   74: iconst_0
    //   75: ireturn
    //   76: astore_0
    //   77: iconst_0
    ...
    //   90: aload_0
    //   91: invokevirtual 134	java/io/FileOutputStream:close	()V
    //   94: iconst_0
    //   95: ireturn
    //   96: astore_0
    //   97: iconst_0
    ...
    //   103: ifnull +11 -> 114
    //   106: aload_1
    //   107: invokevirtual 133	java/io/FileOutputStream:flush	()V
    //   110: aload_1
...
/* Location:
 * Qualified Name:     com.tencent.mm.pluginsdk.i.a.d.a
