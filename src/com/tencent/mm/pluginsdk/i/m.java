...
public final class m
{
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (localObject != null)
        {
          ...
          continue;
          localObject = bG(hour, j);
          continue;
          localObject = bG(minute, j);
          continue;
          k = month;
          if (j >= 4)
          {
          ...
          {
            localObject = bG(k + 1, j);
            continue;
            localObject = bG(second, j);
            continue;
            ...
            if (j < 2)
            {
              ...
              for (;;)
              {
                k = (int)(l / 3600L);
                n = (int)(l % 3600L / 60L);
                ((StringBuilder)localObject).append(bG(k, 2));
                ((StringBuilder)localObject).append(bG(n, 2));
  ...
  private static String bG(int paramInt1, int paramInt2)
  {
...
/* Location:
 * Qualified Name:     com.tencent.mm.pluginsdk.i.m
