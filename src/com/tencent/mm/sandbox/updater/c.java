  ...
  extends com.tencent.mm.sandbox.monitor.c
{
  ...
  private String jTs;
  private aa jTt = new aa()
  {
    public final void handleMessage(Message paramAnonymousMessage)
    {
      if ((1 == what) && (!c.a(c.this)))
      {
        new File(aTM()).delete();
        if (arg1 != 0) {
          break label79;
      ...
      for (;;)
      {
        ...
        label79:
        if (arg1 == 3) {
          c.b(c.this).a(3, -1, (alq)obj);
        } else if (arg1 == 4) {
          c.b(c.this).a(4, -1, (alq)obj);
        }
      }
    }
  };
  private b.a jTu = new b.a()
  {
    public final void J(int paramAnonymousInt1, int paramAnonymousInt2)
    {
      u.d("!56@/B4Tb64lLpK+IBX8XDgnvlltEyUofJIkWxWU3EihDr6zrocW4g7iOg==", "progress, total=" + paramAnonymousInt1 + ", offset=" + paramAnonymousInt2);
      c.b(c.this).J(paramAnonymousInt1, paramAnonymousInt2);
    }
    ...
    public final void a(int paramAnonymousInt1, int paramAnonymousInt2, alq paramAnonymousalq)
    {
      ...
      {
        u.e("!56@/B4Tb64lLpK+IBX8XDgnvlltEyUofJIkWxWU3EihDr6zrocW4g7iOg==", "scene error. netRet=" + paramAnonymousInt1);
      ...
      try
      {
        if (com.tencent.mm.a.e.aw(aTM()) < c.f(c.this))
        {
      ...
      catch (Exception localException)
      {
        ...
        c.b(c.this).a(-1, -1, paramAnonymousalq);
        return;
      }
      if (c.g(c.this))
      {
        if (!c.h(c.this).equalsIgnoreCase(com.tencent.mm.a.g.aC(aTM())))
        {
          u.e("!56@/B4Tb64lLpK+IBX8XDgnvlltEyUofJIkWxWU3EihDr6zrocW4g7iOg==", "pack md5 check error");
          new File(aTM()).delete();
          c.b(c.this).a(2, -1, paramAnonymousalq);
          return;
        }
        c.a(c.this, paramAnonymousalq);
        return;
      }
      if (!c.i(c.this).equalsIgnoreCase(com.tencent.mm.a.g.aC(aTM())))
      {
      ...
      com.tencent.mm.a.e.f(com.tencent.mm.sandbox.monitor.c.jSK, c.j(c.this) + ".temp", c.k(c.this) + ".apk");
      c.b(c.this).a(200, 0, paramAnonymousalq);
    }
    
    public final void jdMethod_do(long paramAnonymousLong)
    {
      c.b(c.this).jdMethod_do(paramAnonymousLong);
    }
    
    public final void dp(long paramAnonymousLong)
    {
      c.b(c.this).dp(paramAnonymousLong);
    }
  };
  ...
  public c(int paramInt1, String paramString, int paramInt2, String[] paramArrayOfString, boolean paramBoolean)
  {
    ...
    jTp = paramArrayOfString;
  }
  
  private int aTV()
  {
    u.i("!56@/B4Tb64lLpK+IBX8XDgnvlltEyUofJIkWxWU3EihDr6zrocW4g7iOg==", "requestCount=" + hzJ + ", curLinkIdx = " + hzJ / 5);
    return hzJ / 5;
  }
  ...
  public final void a(b.a parama)
  {
    ...
    {
      u.e("!56@/B4Tb64lLpK+IBX8XDgnvlltEyUofJIkWxWU3EihDr6zrocW4g7iOg==", "SDCard not available.");
      parama.a(-1, -1, null);
      return;
    }
    if (bVa)
    {
      u.e("!56@/B4Tb64lLpK+IBX8XDgnvlltEyUofJIkWxWU3EihDr6zrocW4g7iOg==", "netscene had been canceled.");
      parama.a(-1, -1, null);
      return;
    }
    if ((aTO()) || (aTV() >= jTp.length))
    {
      u.e("!56@/B4Tb64lLpK+IBX8XDgnvlltEyUofJIkWxWU3EihDr6zrocW4g7iOg==", "exceed max download url. url count = " + jTp.length);
      if (jTr)
      {
        parama.a(1, -1, null);
        return;
    ...
    {
      u.e("!56@/B4Tb64lLpK+IBX8XDgnvlltEyUofJIkWxWU3EihDr6zrocW4g7iOg==", "SDCard full");
      if (jTr)
      {
        parama.a(13, -1, null);
        return;
    ...
    jTq = new a(jSM, com.tencent.mm.a.e.aw(aTM()), jTu);
    jTq.execute(new String[] { jTp[aTV()] });
  }
  ...
  {
    u.d("!56@/B4Tb64lLpK+IBX8XDgnvlltEyUofJIkWxWU3EihDr6zrocW4g7iOg==", "cancel netscene");
    bVa = true;
    if ((jTq != null) && (!jTq.isCancelled())) {
      jTq.cancel(true);
    }
  }
    ...
    private OutputStream jTB = new OutputStream()
    {
      ...
      public final void write(byte[] paramAnonymousArrayOfByte, final int paramAnonymousInt1, int paramAnonymousInt2)
      {
        ...
        do
        {
          ...
          paramAnonymousInt2 = com.tencent.mm.a.e.a(aTM(), jTC.toByteArray(), paramAnonymousInt1);
          jTC.reset();
