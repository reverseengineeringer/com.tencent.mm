  ...
  extends com.tencent.mm.sandbox.monitor.c
{
  ...
  private ac ksN = new ac()
  {
    public final void handleMessage(Message paramAnonymousMessage)
    {
      ...
      for (;;)
      {
        ...
        label79:
        if (arg1 == 3) {
          c.b(c.this).a(3, -1, (amb)obj);
        } else if (arg1 == 4) {
          c.b(c.this).a(4, -1, (amb)obj);
        }
      }
    }
  };
  private b.a ksO = new b.a()
  {
    public final void L(int paramAnonymousInt1, int paramAnonymousInt2)
    {
      ...
      c.b(c.this).L(paramAnonymousInt1, paramAnonymousInt2);
    }
    ...
    public final void a(int paramAnonymousInt1, int paramAnonymousInt2, amb paramAnonymousamb)
    {
      ...
      try
      {
        if (com.tencent.mm.a.e.aA(aYJ()) < c.f(c.this))
        {
      ...
      catch (Exception localException)
      {
        ...
        c.b(c.this).a(-1, -1, paramAnonymousamb);
        return;
      }
      if (c.g(c.this))
      {
        if (!c.h(c.this).equalsIgnoreCase(com.tencent.mm.a.g.aH(aYJ())))
        {
          v.e("MicroMsg.NetSceneGetUpdatePackFromCDN", "pack md5 check error");
          new File(aYJ()).delete();
          c.b(c.this).a(2, -1, paramAnonymousamb);
          return;
        }
        c.a(c.this, paramAnonymousamb);
        return;
      }
      if (!c.i(c.this).equalsIgnoreCase(com.tencent.mm.a.g.aH(aYJ())))
      {
      ...
      com.tencent.mm.a.e.h(com.tencent.mm.sandbox.monitor.c.kse, c.j(c.this) + ".temp", c.k(c.this) + ".apk");
      c.b(c.this).a(200, 0, paramAnonymousamb);
    }
    
    public final void dF(long paramAnonymousLong)
    {
      c.b(c.this).dF(paramAnonymousLong);
    }
    
    public final void dG(long paramAnonymousLong)
    {
      c.b(c.this).dG(paramAnonymousLong);
    }
  };
  ...
  public c(int paramInt1, String paramString, int paramInt2, String[] paramArrayOfString, boolean paramBoolean)
  {
    ...
    ksJ = paramArrayOfString;
  }
  
  private int aYS()
  {
    v.i("MicroMsg.NetSceneGetUpdatePackFromCDN", "requestCount=" + hRD + ", curLinkIdx = " + hRD / 5);
    return hRD / 5;
  }
  ...
  public final void a(b.a parama)
  {
    ...
    if ((aYL()) || (aYS() >= ksJ.length))
    {
      v.e("MicroMsg.NetSceneGetUpdatePackFromCDN", "exceed max download url. url count = " + ksJ.length);
      if (ksL)
      {
        parama.a(1, -1, null);
        return;
    ...
    ksK = new a(ksg, com.tencent.mm.a.e.aA(aYJ()), ksO);
    ksK.execute(new String[] { ksJ[aYS()] });
  }
    ...
    private OutputStream ksV = new OutputStream()
    {
      ...
      public final void write(byte[] paramAnonymousArrayOfByte, final int paramAnonymousInt1, int paramAnonymousInt2)
      {
        ...
        do
        {
          ...
          paramAnonymousInt2 = com.tencent.mm.a.e.a(aYJ(), ksW.toByteArray(), paramAnonymousInt1);
          ksW.reset();
