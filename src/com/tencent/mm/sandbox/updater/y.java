  ...
  extends g
{
  ...
  private b.a hWw;
  private a hWx = null;
  private b.a hWy = new z(this);
  private int uin;
  
  public y(int paramInt1, String paramString, int paramInt2, int paramInt3, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, String[] paramArrayOfString, boolean paramBoolean)
  {
    super(paramInt1, paramString, paramInt2, paramBoolean);
    hWv = paramArrayOfString;
    if ((paramArrayOfString == null) || (paramArrayOfString.length == 0)) {
      hWv = new String[] { "short.weixin.qq.com" };
    }
    uin = paramInt3;
    bRw = paramArrayOfByte1;
    buo = paramArrayOfByte2;
  }
  ...
  public final void a(b.a parama)
  {
    ...
    if (i > 1000)
    {
      t.d("!44@/B4Tb64lLpK+IBX8XDgnvlltEyUofJIkgG6dDIkrLQ8=", "doSceneCnt > DOSCENE_LIMIT, return");
      hWw.a(-1, -1, null);
      return;
    }
    if (!h.C(hVZ))
    {
      t.e("!44@/B4Tb64lLpK+IBX8XDgnvlltEyUofJIkgG6dDIkrLQ8=", "SDCard full, packSize=[%s]", new Object[] { Integer.valueOf(hVZ) });
      parama.a(-1, -1, null);
      return;
    }
    parama = new rp();
    Object localObject = new cj();
    hlf = com.tencent.mm.protocal.b.hgo;
    hle = com.tencent.mm.al.b.au(q.oI().getBytes()).lV(16);
    hlg = com.tencent.mm.al.b.au(com.tencent.mm.protocal.b.hgg.getBytes()).lV(132);
    hih = 0;
    hlO = com.tencent.mm.al.b.au(bRw).lV(36);
    cUG = uin;
    hLO = ((cj)localObject);
    hBt = hVY;
    hjW = hWa;
    hjV = hVZ;
    localObject = new a(hWv[(hWu / 5)], hWy);
    hWx = ((a)localObject);
    ((a)localObject).execute(new rp[] { parama });
  }
  
  public final void cancel()
  {
    t.i("!44@/B4Tb64lLpK+IBX8XDgnvlltEyUofJIkgG6dDIkrLQ8=", "do cancel, updateType = " + hVY);
    if ((hWx != null) && (!hWx.isCancelled())) {
      hWx.cancel(true);
    }
  }
    ...
    extends AsyncTask
  {
    ...
    /* Error */
    private com.tencent.mm.protocal.b.rq a(rp... paramVarArgs)
    {
      // Byte code:
      //   0: aload_1
      //   1: arraylength
