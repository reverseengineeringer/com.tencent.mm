  ...
  extends b
{
  ...
  public final boolean a(java.io.InputStream paramInputStream, java.util.Map<String, java.util.List<String>> paramMap)
  {
    ...
    //   34: aload_0
    //   35: getfield 32	com/tencent/mm/plugin/sns/e/a/c:gYK	Lcom/tencent/mm/plugin/sns/e/a/a;
    //   38: invokevirtual 38	com/tencent/mm/plugin/sns/e/a/a:getPath	()Ljava/lang/String;
    //   41: invokevirtual 42	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   44: aload_0
    //   45: getfield 32	com/tencent/mm/plugin/sns/e/a/c:gYK	Lcom/tencent/mm/plugin/sns/e/a/a;
    //   48: invokevirtual 45	com/tencent/mm/plugin/sns/e/a/a:aCj	()Ljava/lang/String;
    ...
    //   65: astore_2
    //   66: aload 11
    //   68: invokestatic 54	com/tencent/mm/modelsfs/f:jl	(Ljava/lang/String;)Ljava/lang/String;
    //   71: invokestatic 60	com/tencent/mm/modelsfs/FileOp:jc	(Ljava/lang/String;)J
    //   74: lstore 5
    //   76: aload 8
    //   78: astore 7
    //   80: aload 9
    ...
    //   102: invokestatic 76	com/tencent/mm/sdk/platformtools/v:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   105: aload 8
    //   107: astore 7
    //   109: aload 9
    //   111: astore_2
    //   112: aload 11
    //   114: invokestatic 80	com/tencent/mm/modelsfs/FileOp:ja	(Ljava/lang/String;)Ljava/io/OutputStream;
    //   117: astore 8
    //   119: iconst_1
    //   120: istore_3
    //   121: aload 8
    ...
    //   146: aload 8
    //   148: astore_2
    //   149: invokestatic 91	com/tencent/mm/plugin/sns/e/ad:atL	()Ljava/lang/String;
    //   152: invokestatic 97	com/tencent/mm/plugin/sns/data/i:vs	(Ljava/lang/String;)Z
    //   155: ifne +52 -> 207
    //   158: aload 8
    //   160: astore 7
    //   162: aload 8
    ...
    //   165: ldc 62
    //   167: ldc 99
    //   169: invokestatic 76	com/tencent/mm/sdk/platformtools/v:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   172: aload 8
    //   174: astore 7
    //   176: aload 8
    //   178: astore_2
    ...
    //   232: iload 4
    //   234: aload_0
    //   235: getfield 112	com/tencent/mm/plugin/sns/e/a/c:gYW	I
    //   238: iadd
    //   239: putfield 112	com/tencent/mm/plugin/sns/e/a/c:gYW	I
    //   242: aload 8
    //   244: astore 7
    //   246: aload 8
    //   248: astore_2
    //   249: aload_0
    //   250: getfield 112	com/tencent/mm/plugin/sns/e/a/c:gYW	I
    //   253: aload_0
    //   254: getfield 16	com/tencent/mm/plugin/sns/e/a/c:gYY	I
    //   257: isub
    //   258: ldc 113
    //   260: iload_3
    //   261: imul
    ...
    //   269: aload 8
    //   271: astore_2
    //   272: invokestatic 117	com/tencent/mm/plugin/sns/e/ad:aBE	()Lcom/tencent/mm/plugin/sns/e/b;
    //   275: astore 9
    //   277: aload 8
    //   279: astore 7
    //   281: aload 8
    //   283: astore_2
    //   284: aload_0
    //   285: getfield 32	com/tencent/mm/plugin/sns/e/a/c:gYK	Lcom/tencent/mm/plugin/sns/e/a/a;
    //   288: getfield 121	com/tencent/mm/plugin/sns/e/a/a:mediaId	Ljava/lang/String;
    //   291: astore 12
    //   293: aload 8
    //   295: astore 7
    //   297: aload 8
    //   299: astore_2
    //   300: invokestatic 125	com/tencent/mm/plugin/sns/e/ad:acj	()Lcom/tencent/mm/sdk/platformtools/ac;
    //   303: new 127	com/tencent/mm/plugin/sns/e/b$3
    //   306: dup
    //   307: aload 9
    //   309: aload 12
    //   311: aload 11
    //   313: invokespecial 130	com/tencent/mm/plugin/sns/e/b$3:<init>	(Lcom/tencent/mm/plugin/sns/e/b;Ljava/lang/String;Ljava/lang/String;)V
    //   316: invokevirtual 136	com/tencent/mm/sdk/platformtools/ac:post	(Ljava/lang/Runnable;)Z
    //   319: pop
    //   320: aload 8
    //   322: astore 7
    //   324: aload 8
    ...
    //   327: aload_0
    //   328: aload_0
    //   329: getfield 112	com/tencent/mm/plugin/sns/e/a/c:gYW	I
    //   332: putfield 16	com/tencent/mm/plugin/sns/e/a/c:gYY	I
    //   335: iload_3
    //   336: iconst_1
    //   337: iadd
    //   338: istore_3
    ...
    //   361: aload_0
    //   362: getfield 32	com/tencent/mm/plugin/sns/e/a/c:gYK	Lcom/tencent/mm/plugin/sns/e/a/a;
    //   365: invokevirtual 38	com/tencent/mm/plugin/sns/e/a/a:getPath	()Ljava/lang/String;
    //   368: invokevirtual 42	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   371: aload_0
    //   372: getfield 32	com/tencent/mm/plugin/sns/e/a/c:gYK	Lcom/tencent/mm/plugin/sns/e/a/a;
    //   375: invokevirtual 45	com/tencent/mm/plugin/sns/e/a/a:aCj	()Ljava/lang/String;
    ...
    //   384: invokestatic 60	com/tencent/mm/modelsfs/FileOp:jc	(Ljava/lang/String;)J
    //   387: lstore 5
    //   389: ldc 62
    ...
    //   408: invokestatic 76	com/tencent/mm/sdk/platformtools/v:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   411: iconst_1
    //   412: ireturn
    //   413: astore_1
    //   414: aload 7
    ...
    //   443: invokestatic 149	com/tencent/mm/sdk/platformtools/v:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   446: aload 7
    //   448: ifnull -243 -> 205
    //   451: aload 7
    ...
    //   0	479	2	paramMap	java.util.Map<String, java.util.List<String>>
    //   120	219	3	i	int
    //   134	105	4	j	int
    //   74	327	5	l	long
    //   8	444	7	localOutputStream1	java.io.OutputStream
    //   4	346	8	localOutputStream2	java.io.OutputStream
    //   1	307	9	localb	com.tencent.mm.plugin.sns.e.b
  ...
  {
    long l = FileOp.jc(gYK.getPath() + gYK.aCj());
    v.i("MicroMsg.SnsDownloadAdSight", "preceeData  downloadLen " + l + " " + gYU);
    if (l < gYU + gYX) {
      return false;
    }
    String str = i.j(aus);
  ...
  {
    gYX = FileOp.jc(gYK.getPath() + gYK.aCj());
    if (gYX > 0L)
    {
      v.i("MicroMsg.SnsDownloadAdSight", "appendHttpArg range " + gYX);
      params.setRequestProperty("RANGE", "bytes=" + gYX + "-");
    }
    return params;
  }
...
/* Location:
 * Qualified Name:     com.tencent.mm.plugin.sns.e.a.c
