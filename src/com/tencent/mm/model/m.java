...
public final class m
{
  private a bAh = null;
  boolean bAi = false;
  BlockingQueue bAj = new ArrayBlockingQueue(80);
  public b bAk = null;
  aa handler = new aa(tvjVF.getLooper())
  {
    public final void handleMessage(final Message paramAnonymousMessage)
    {
      for (;;)
      {
        try
        {
          ...
          int i = com.tencent.mm.a.e.aw(filename);
          if (i > 0) {
            z.a.bAt.K(i, 0);
          }
          ab.j(new Runnable()
          {
            ...
            {
              if (bAk != null) {
                bAk.a(paramAnonymousMessageurl, paramAnonymousMessagefilename, paramAnonymousMessagepos);
              }
            }
          });
          return;
        ...
        {
          u.e("!32@/B4Tb64lLpINwg6pdiU5D99hnbItqI3s", "exception:%s", new Object[] { ay.b(paramAnonymousMessage) });
          return;
        }
        label203:
        m.a(m.this, 14L, 1L);
  ...
  {
    bAi = paramBoolean;
    u.d("!32@/B4Tb64lLpINwg6pdiU5D99hnbItqI3s", "getPicService, isFromWebView:%b", new Object[] { Boolean.valueOf(paramBoolean) });
  }
  
  public final String e(String paramString, int paramInt1, int paramInt2)
  {
    if (paramString == null) {}
    for (String str = null;; str = ah.tD().rx() + "/reader_" + paramInt1 + "_" + g.m(paramString.getBytes()) + ".jpg")
    {
      u.d("!32@/B4Tb64lLpINwg6pdiU5D99hnbItqI3s", "getPicfileByUrl type:" + paramInt1 + " url:" + paramString);
      try
      {
        boolean bool = com.tencent.mm.a.e.ax(str);
        if (!bool) {
          break;
        }
        return str;
      ...
      {
        u.e("!32@/B4Tb64lLpINwg6pdiU5D99hnbItqI3s", "exception:%s", new Object[] { ay.b(localException) });
      }
    }
    try
    {
      bAj.add(new c(paramString, str, paramInt2));
      if ((bAh == null) || (!com.tencent.mm.sdk.i.e.C(bAh)))
      {
        com.tencent.mm.sdk.i.e.remove(bAh);
        bAh = new a();
        com.tencent.mm.sdk.i.e.a(bAh, "GetPicService_getPic");
      }
    }
    catch (Exception paramString)
    {
      for (;;)
      {
        u.e("!32@/B4Tb64lLpINwg6pdiU5D99hnbItqI3s", "exception:%s", new Object[] { ay.b(paramString) });
      }
    }
    return null;
  }
