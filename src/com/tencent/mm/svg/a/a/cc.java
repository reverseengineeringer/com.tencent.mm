  ...
  extends c
{
  ...
  protected final int i(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      ((Path)localObject2).moveTo(6.0F, 27.576923F);
      ((Path)localObject2).lineTo(10.2F, 23.538462F);
      ((Path)localObject2).lineTo(19.0F, 31.923077F);
      ((Path)localObject2).lineTo(37.8F, 14.0F);
      ((Path)localObject2).lineTo(42.0F, 18.038462F);
      ((Path)localObject2).lineTo(19.0F, 40.0F);
      ((Path)localObject2).lineTo(6.0F, 27.576923F);
      ((Path)localObject2).lineTo(6.0F, 27.576923F);
