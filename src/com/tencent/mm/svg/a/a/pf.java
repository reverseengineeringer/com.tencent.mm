  ...
  extends c
{
  ...
  protected final int h(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      ((Path)localObject1).moveTo(30.441F, 26.842F);
      ((Path)localObject1).cubicTo(37.66F, 23.196F, 44.88F, 19.55F, 52.1F, 15.906F);
      ((Path)localObject1).cubicTo(48.438F, 23.169F, 44.77F, 30.428F, 41.103F, 37.689F);
      ((Path)localObject1).cubicTo(40.307F, 39.233F, 38.989F, 40.497F, 37.421F, 41.24F);
      ((Path)localObject1).cubicTo(30.25F, 44.863F, 23.073F, 48.474F, 15.907F, 52.104F);
      ((Path)localObject1).cubicTo(19.564F, 44.858F, 23.221F, 37.612F, 26.878F, 30.367F);
      ((Path)localObject1).cubicTo(27.648F, 28.851F, 28.918F, 27.597F, 30.441F, 26.842F);
      ((Path)localObject1).lineTo(30.441F, 26.842F);
      ((Path)localObject1).close();
      ((Path)localObject1).moveTo(33.349F, 31.077F);
      ((Path)localObject1).cubicTo(31.868F, 31.377F, 30.79F, 32.916F, 31.031F, 34.411F);
      ((Path)localObject1).cubicTo(31.209F, 36.036F, 32.892F, 37.282F, 34.499F, 36.962F);
      ((Path)localObject1).cubicTo(36.126F, 36.734F, 37.317F, 35.001F, 36.939F, 33.4F);
      ((Path)localObject1).cubicTo(36.654F, 31.804F, 34.922F, 30.684F, 33.349F, 31.077F);
      ((Path)localObject1).lineTo(33.349F, 31.077F);
      ((Path)localObject1).close();
