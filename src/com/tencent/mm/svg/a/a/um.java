  ...
  extends c
{
  ...
  protected final int h(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      localCanvas.save();
      localObject4 = c.a((float[])localObject4, 1.0F, 0.0F, -223.0F, 0.0F, 1.0F, -362.0F);
      ((Matrix)localObject3).reset();
      ((Matrix)localObject3).setValues((float[])localObject4);
      localCanvas.concat((Matrix)localObject3);
      localCanvas.save();
      localObject4 = c.a((float[])localObject4, 1.0F, 0.0F, 98.0F, 0.0F, 1.0F, 362.0F);
      ((Matrix)localObject3).reset();
      ((Matrix)localObject3).setValues((float[])localObject4);
      localCanvas.concat((Matrix)localObject3);
      localCanvas.save();
      localObject4 = c.a((float[])localObject4, 1.0F, 0.0F, 125.0F, 0.0F, 1.0F, 0.0F);
      ((Matrix)localObject3).reset();
      ((Matrix)localObject3).setValues((float[])localObject4);
      localCanvas.concat((Matrix)localObject3);
      localCanvas.save();
...
/* Location:
 * Qualified Name:     com.tencent.mm.svg.a.a.um
