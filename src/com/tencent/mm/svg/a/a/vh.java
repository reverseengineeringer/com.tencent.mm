  ...
  extends c
{
  ...
  protected final int h(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      ((Path)localObject3).cubicTo(143.67F, 0.83F, 172.5F, 13.86F, 192.4F, 35.56F);
      ((Path)localObject3).cubicTo(210.27F, 54.61F, 220.71F, 80.13F, 222.0F, 106.17F);
      ((Path)localObject3).lineTo(222.0F, 115.49F);
      ((Path)localObject3).cubicTo(220.85F, 140.93F, 210.93F, 165.91F, 193.85F, 184.84F);
      ((Path)localObject3).cubicTo(173.91F, 207.48F, 144.4F, 221.16F, 114.26F, 222.0F);
      ((Path)localObject3).lineTo(107.88F, 222.0F);
      ((Path)localObject3).cubicTo(78.88F, 221.22F, 50.43F, 208.59F, 30.55F, 187.44F);
      ((Path)localObject3).cubicTo(12.11F, 168.27F, 1.27F, 142.3F, 0.0F, 115.78F);
      ((Path)localObject3).lineTo(0.0F, 107.09F);
      ((Path)localObject3).cubicTo(1.01F, 80.27F, 11.92F, 53.95F, 30.53F, 34.57F);
      ((Path)localObject3).cubicTo(50.17F, 13.67F, 78.16F, 1.14F, 106.78F, 0.0F);
      ((Path)localObject3).lineTo(106.78F, 0.0F);
      ((Path)localObject3).close();
      ((Path)localObject3).moveTo(166.75F, 67.7F);
      ((Path)localObject3).cubicTo(141.11F, 93.18F, 115.52F, 118.69F, 89.88F, 144.16F);
      ((Path)localObject3).cubicTo(78.65F, 133.04F, 67.47F, 121.87F, 56.26F, 110.74F);
      ((Path)localObject3).cubicTo(55.32F, 109.66F, 53.84F, 108.99F, 52.43F, 109.53F);
      ((Path)localObject3).cubicTo(49.78F, 111.27F, 45.1F, 115.1F, 48.7F, 118.23F);
      ((Path)localObject3).cubicTo(60.56F, 130.06F, 72.47F, 141.86F, 84.32F, 153.7F);
      ((Path)localObject3).cubicTo(85.66F, 154.99F, 86.88F, 156.46F, 88.47F, 157.46F);
      ((Path)localObject3).cubicTo(90.13F, 158.14F, 91.93F, 157.42F, 93.02F, 156.09F);
      ((Path)localObject3).cubicTo(120.24F, 128.93F, 147.59F, 101.89F, 174.75F, 74.68F);
      ((Path)localObject3).cubicTo(177.24F, 72.17F, 174.1F, 69.35F, 172.21F, 67.69F);
      ((Path)localObject3).cubicTo(170.84F, 65.92F, 168.1F, 65.88F, 166.75F, 67.7F);
      ((Path)localObject3).lineTo(166.75F, 67.7F);
      ((Path)localObject3).close();
...
/* Location:
 * Qualified Name:     com.tencent.mm.svg.a.a.vh
