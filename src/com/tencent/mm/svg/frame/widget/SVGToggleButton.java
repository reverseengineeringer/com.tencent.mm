  ...
  implements c
{
  ...
  public SVGToggleButton(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
    a(paramAttributeSet, 0);
  }
  
  public SVGToggleButton(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  {
    if (paramb == null) {
      throw new IllegalArgumentException("Null value exception. SVGToggleButton.setBackgroundSVG()");
    }
...
/* Location:
 * Qualified Name:     com.tencent.mm.svg.frame.widget.SVGToggleButton
