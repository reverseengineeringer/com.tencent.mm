...
import com.tencent.mm.pluginsdk.h.b.a.a;
  ...
  implements j
{
  ...
  {
    return dt.a(paramRunnable, paramMMActivity, paramInt1, paramInt2, paramIntent);
  }
  ...
  public final void a(Activity paramActivity, Intent paramIntent1, Intent paramIntent2, String paramString, int paramInt, k.a parama)
  {
    if (paramActivity != null)
    {
      paramIntent2.setClass(paramActivity, CropImageNewUI.class);
      k.b(paramActivity, paramIntent1, paramIntent2, paramString, paramInt, parama);
    }
  }
  ...
  public final void a(Context paramContext, Intent paramIntent1, Intent paramIntent2)
  {
    ...
    do
    {
      ...
      if (i == 3)
      {
        ...
        MMWizardActivity.q(paramContext, paramIntent1);
        return;
      }
      if (i == 5)
      {
  ...
  {
    if (paramActivity != null) {
      com.tencent.mm.aj.c.a(paramActivity, "location", ".ui.RedirectUI", paramIntent, 4097);
    }
  }
  ...
  public final void a(Intent paramIntent1, int paramInt, MMActivity paramMMActivity, Intent paramIntent2)
  {
    if (paramMMActivity != null)
    {
      ...
      k.a(paramMMActivity, paramIntent2, paramIntent1, ax.tl().rp(), paramInt);
    }
  }
  ...
  {
    m.a(ipQ, thumbData, title, description, paramString3, true, 2, new au(this, paramWXMediaMessage, paramString1, paramString3, paramString2, paramMMActivity));
  }
  ...
  public final void a(MMWizardActivity paramMMWizardActivity, Intent paramIntent)
  {
    ...
    MMWizardActivity.q(paramMMWizardActivity, paramIntent);
  }
  ...
  public final void a(boolean paramBoolean1, boolean paramBoolean2, Context paramContext, String paramString, int paramInt1, int paramInt2)
  {
    ...
    {
      if (!a.b(paramString, paramContext, paramBoolean2)) {
        Toast.makeText(paramContext, paramContext.getString(a.n.video_play_export_file_error), 0).show();
      }
      return;
    }
    ...
    com.tencent.mm.aj.c.c(paramContext, "subapp", ".ui.video.VideoPlayerUI", localIntent);
  }
  
  public final boolean a(Context paramContext, String paramString, Object... paramVarArgs)
  {
    return l.a.gKj.b(paramContext, paramString, paramVarArgs);
  }
  
  public final aa aa(Context paramContext)
  {
    return MMAppMgr.aa(paramContext);
  }
  
  public final Intent ab(Context paramContext)
  {
  ...
  {
    com.tencent.mm.aj.c.c(paramContext, "setting", ".ui.setting.SelfQRCodeUI", new Intent());
  }
  
  public final void ad(Context paramContext)
  {
    com.tencent.mm.aj.c.c(paramContext, "subapp", ".ui.openapi.AddAppUI", new Intent());
  }
  ...
  public final void b(Intent paramIntent, Activity paramActivity)
  {
    if (paramActivity != null)
    {
      ...
      paramActivity.startActivityForResult(paramIntent, 2002);
    }
  }
  ...
  {
    return l.a.gKj.a(paramContext, paramString, false, paramBundle);
  }
  ...
  public final void c(Intent paramIntent, Context paramContext)
  {
    ...
    com.tencent.mm.aj.c.c(paramContext, "setting", ".ui.setting.EditSignatureUI", localIntent);
  }
  
  public final void c(String paramString, Context paramContext)
  {
    Intent localIntent = new Intent();
    localIntent.putExtra("Ksnsupload_type", 0);
    localIntent.putExtra("sns_kemdia_path", paramString);
    com.tencent.mm.aj.c.c(paramContext, "sns", ".ui.SnsUploadUI", localIntent);
  }
  
  public final void c(String paramString1, String paramString2, String paramString3)
  {
    l.a(38, paramString1, paramString2, paramString3, null, null);
  }
  ...
  public final void cancelNotification(String paramString)
  {
    ...
    if (paramString != null)
    {
      int i = com.tencent.mm.booter.notification.queue.c.nL().getId(paramString);
      t.d("!44@/B4Tb64lLpKR3MWtFvfaIO9VjdH9q7JYDEFwdMnORTc=", "cancel : %s", new Object[] { paramString });
      com.tencent.mm.booter.notification.queue.c.nL().cancel(i);
    }
  }
  ...
  public final void d(Context paramContext, Intent paramIntent)
  {
    ...
    com.tencent.mm.aj.c.c(paramContext, "safedevice", ".ui.MySafeDeviceListUI", paramIntent);
  }
  ...
  public final void d(Intent paramIntent, Context paramContext)
  {
    ...
    com.tencent.mm.aj.c.c(paramContext, "profile", ".ui.ContactInfoUI", localIntent);
  }
  ...
  public final void f(Context paramContext, Intent paramIntent)
  {
    ...
    com.tencent.mm.aj.c.a(paramContext, "safedevice", ".ui.SecurityAccountIntroUI", paramIntent);
  }
  ...
  public final void g(Intent paramIntent, Context paramContext)
  {
    ...
    MMWizardActivity.q(paramContext, paramIntent);
  }
  ...
  public final void h(Intent paramIntent, Context paramContext)
  {
    ...
    MMWizardActivity.q(paramContext, localIntent);
  }
  ...
  public final void i(Intent paramIntent, Context paramContext)
  {
    ...
    paramIntent.setClass(paramContext, QQGroupUI.class);
    paramContext.startActivity(paramIntent);
  }
  ...
  public final void k(Context paramContext, Intent paramIntent)
  {
    ...
    com.tencent.mm.aj.c.c(paramContext, "game", ".ui.GameDetailUI", paramIntent);
  }
  ...
  public final void k(Intent paramIntent, Context paramContext)
  {
    ...
    com.tencent.mm.aj.c.c(paramContext, "webview", ".ui.tools.WebViewUI", localIntent);
  }
  ...
  {
    af.a(paramContext, paramIntent.getBundleExtra("reportArgs"));
  }
  ...
  {
    l.a.gKj.a(paramContext, paramString, true);
  }
  ...
  public final void n(Intent paramIntent, Context paramContext)
  {
    if (paramContext != null)
    {
      ...
      com.tencent.mm.aj.c.c(paramContext, "sns", ".ui.SnsUploadUI", paramIntent);
    }
  }
  ...
  {
    if (paramContext != null) {
      com.tencent.mm.aj.c.c(paramContext, "location", ".ui.RedirectUI", paramIntent);
    }
  }
  ...
  {
    if (paramContext != null) {
      com.tencent.mm.aj.c.c(paramContext, "setting", ".ui.qrcode.ShowQRCodeStep1UI", paramIntent);
    }
  }
  ...
  {
    if (paramContext != null) {
      com.tencent.mm.aj.c.c(paramContext, "setting", ".ui.setting.SettingsLanguageUI", paramIntent);
    }
  }
  ...
  public final void v(Intent paramIntent, Context paramContext)
  {
    ...
    com.tencent.mm.aj.c.c(paramContext, "subapp", ".ui.gallery.GestureGalleryUI", localIntent);
  }
  ...
  public final void x(Intent paramIntent, Context paramContext)
  {
    if (paramContext != null)
    {
      ...
      com.tencent.mm.aj.c.c(paramContext, "subapp", ".ui.pluginapp.ContactSearchUI", localIntent);
    }
  }
  ...
  public final void y(Intent paramIntent, Context paramContext)
  {
    if (paramContext != null)
    {
      ...
      com.tencent.mm.aj.c.c(paramContext, "subapp", ".ui.pluginapp.ContactSearchResultUI", localIntent);
    }
  }
...
/* Location:
 * Qualified Name:     com.tencent.mm.app.at
