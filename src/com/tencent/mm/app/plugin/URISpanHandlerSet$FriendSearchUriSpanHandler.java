  ...
  extends URISpanHandlerSet.BaseUriSpanHandler
{
  ...
  final boolean a(ah paramah, f paramf)
  {
    if (type == 17)
    {
      ...
      c.t(URISpanHandlerSet.a(apd), "subapp", ".ui.pluginapp.ContactSearchUI");
      return true;
    }
    return false;
  }
  ...
  final boolean a(String paramString, boolean paramBoolean, n paramn, Bundle paramBundle)
  {
    if (paramString.equals("weixin://findfriend/search"))
    {
      ...
      c.c(URISpanHandlerSet.a(apd), "subapp", ".ui.pluginapp.ContactSearchUI", paramString);
      return true;
    }
    return false;
  }
  ...
  final ah aZ(String paramString)
  {
    if (paramString.trim().startsWith("weixin://findfriend/search")) {
      return new ah(paramString, 17, null);
    }
    return null;
  }
