...
{
  private static Vector<WeakReference<a>> bxl = new Vector();
  private static LinkedList<a> chb = new LinkedList();
  ...
  public static Bitmap a(i parami)
  {
    ...
    if (parami.Gf()) {
      return b.a(b.chc, parami);
    }
    return b.b(b.chc, parami);
  }
  
  public static boolean a(a parama)
  {
    return bxl.add(new WeakReference(parama));
  }
  
  private static boolean b(i parami)
  {
    return (parami != null) && (!s.kf(parami.Gb()));
  }
  
  public static boolean b(a parama)
  {
    chb.remove(parama);
    return chb.add(parama);
  }
  
  public static boolean c(a parama)
  {
    return chb.remove(parama);
  }
