...
{
  private static Vector bEa = new Vector();
  private static LinkedList clY = new LinkedList();
  
  public static Bitmap a(j paramj)
  {
    if (!b(paramj)) {
      return null;
    }
    ...
    if (paramj.FJ()) {
      return b.a(b.clZ, paramj);
    }
    return b.b(b.clZ, paramj);
  }
  
  public static boolean a(a parama)
  {
    return bEa.add(new WeakReference(parama));
  }
  
  private static boolean b(j paramj)
  {
    return (paramj != null) && (!ay.kz(paramj.FG()));
  }
  
  public static boolean b(a parama)
  {
    clY.remove(parama);
    return clY.add(parama);
  }
  
  public static boolean c(a parama)
  {
    return clY.remove(parama);
  }
  
  public static Bitmap k(String paramString, int paramInt1, int paramInt2)
  {
    return b.k(paramString, paramInt1, paramInt2);
  }
  
  public static Bitmap ku(String paramString)
  {
    return b.ku(paramString);
  }
  ...
  private static enum b
  {
    ...
    private Map cma = new HashMap();
    private Map cmb = new HashMap();
    private am cmc = null;
    private am cmd = null;
    ...
    private void b(j paramj, Bitmap paramBitmap)
    {
      ...
      String str = paramj.getCacheKey();
      if (cmb.containsKey(str)) {}
      for (paramj = (Bitmap)((WeakReference)cmb.get(str)).get();; paramj = null)
      {
        if ((paramj == null) || (paramj.isRecycled()))
        {
          cmb.remove(str);
          cmb.put(str, new WeakReference(paramBitmap));
        }
        return;
      }
    }
    ...
    {
      Assert.assertTrue("picture strategy here must be validity", k.c(paramj));
      String str = paramj.FG();
      c localc = (c)cma.get(str);
      ...
      if (cmi) {
        if (cmj >= 3)
        {
          if (ay.am(cmk) < 120L)
          {
            u.w("!32@/B4Tb64lLpI9x0Y3l+KjNcgr8YiEJ3lN", "download fail interval less than %d s for %s", new Object[] { Integer.valueOf(120), str });
            return null;
          }
          cmj = 0;
          cmi = false;
          cmk = ((int)ay.FR());
          cma.put(str, localObject);
        }
      }
      for (;;)
      {
        if (paramj.FI())
        {
          ...
          if (localObject != null)
          {
            ...
            if (ay.am(cmk) < 120L)
            {
              u.d("!32@/B4Tb64lLpI9x0Y3l+KjNcgr8YiEJ3lN", "downloading interval less than %d s for %s", new Object[] { Integer.valueOf(120), str });
              return null;
            }
            cmj += 1;
            cmk = ((int)ay.FR());
          ...
          if ((cmc == null) || (cmc.aVi())) {
            cmc = new am(1, "readerapp-pic-logic-download", 3);
          }
          cmc.c(new a(paramj));
          return null;
        }
      ...
      if ((cmd == null) || (cmd.aVi())) {
        cmd = new am(1, "readerapp-pic-logic-reader", 1);
      }
      cmd.c(new b(paramj));
      return null;
    }
    ...
    public static Bitmap k(String paramString, int paramInt1, int paramInt2)
    {
      ...
      if (ay.kz(paramString)) {
        u.w("!32@/B4Tb64lLpI9x0Y3l+KjNcgr8YiEJ3lN", "error input, path is null");
      }
      ...
      do
      {
        do
        {
          ...
          {
            u.w("!32@/B4Tb64lLpI9x0Y3l+KjNcgr8YiEJ3lN", "error input, targetWidth %d, targetHeight %d", new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) });
            return null;
          }
    ...
    public static Bitmap ku(String paramString)
    {
      ...
      DisplayMetrics localDisplayMetrics = cme;
    ...
    protected final Bitmap a(j paramj, Bitmap paramBitmap)
    {
      ...
      if (paramBitmap != null)
      {
        Bitmap localBitmap = paramj.a(paramBitmap, j.a.clW);
        if ((localBitmap != paramBitmap) && (!paramBitmap.isRecycled()))
        {
          u.i("!32@/B4Tb64lLpI9x0Y3l+KjNcgr8YiEJ3lN", "recycle bitmap:%s", new Object[] { paramBitmap.toString() });
          paramBitmap.recycle();
        }
        b(paramj, localBitmap);
        return localBitmap;
      }
      paramj.a(j.a.clW, null);
      return paramBitmap;
    }
