...
{
  private static LinkedList bVb = new LinkedList();
  private static Vector brW = new Vector();
  ...
  public static Bitmap a(j paramj)
  {
    ...
    if (paramj.DD()) {
      return b.a(b.bVc, paramj);
    }
    return b.b(b.bVc, paramj);
  }
  
  public static boolean a(a parama)
  {
    return brW.add(new WeakReference(parama));
  }
  
  private static boolean b(j paramj)
  {
    return (paramj != null) && (!bn.iW(paramj.Dz()));
  }
  
  public static boolean b(a parama)
  {
    bVb.remove(parama);
    return bVb.add(parama);
  }
  
  public static boolean c(a parama)
  {
    return bVb.remove(parama);
  }
  
  public static Bitmap iQ(String paramString)
  {
    return b.iQ(paramString);
  }
  
  public static Bitmap j(String paramString, int paramInt1, int paramInt2)
  {
    return b.j(paramString, paramInt1, paramInt2);
  }
