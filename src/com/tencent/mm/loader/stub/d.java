...
{
  /* Error */
  public static String d(android.content.Context paramContext, int paramInt)
  {
    // Byte code:
    //   0: aload_0
    //   1: ifnull +7 -> 8
    ...
    //   11: aload_0
    //   12: ldc 12
    //   14: invokevirtual 18	android/content/Context:getSystemService	(Ljava/lang/String;)Ljava/lang/Object;
    //   17: checkcast 20	android/app/ActivityManager
    //   20: invokevirtual 24	android/app/ActivityManager:getRunningAppProcesses	()Ljava/util/List;
    //   23: invokeinterface 30 1 0
    //   28: astore_0
    //   29: aload_0
    ...
    //   44: checkcast 42	android/app/ActivityManager$RunningAppProcessInfo
    //   47: astore 4
    //   49: aload 4
    //   51: getfield 46	android/app/ActivityManager$RunningAppProcessInfo:pid	I
    //   54: iload_1
    //   55: if_icmpne -26 -> 29
    //   58: aload 4
    //   60: getfield 50	android/app/ActivityManager$RunningAppProcessInfo:processName	Ljava/lang/String;
    //   63: ifnull -34 -> 29
    //   66: aload 4
    //   68: getfield 50	android/app/ActivityManager$RunningAppProcessInfo:processName	Ljava/lang/String;
    //   71: ldc 10
    //   73: invokevirtual 56	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   76: ifne -47 -> 29
    //   79: aload 4
    //   81: getfield 50	android/app/ActivityManager$RunningAppProcessInfo:processName	Ljava/lang/String;
    //   84: astore_0
    //   85: aload_0
    //   86: areturn
    //   87: astore_0
    ...
    //   95: aconst_null
    //   96: astore 4
    //   98: new 58	java/io/FileInputStream
    //   101: dup
    //   102: new 60	java/lang/StringBuilder
    //   105: dup
    //   106: ldc 62
    //   108: invokespecial 66	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   111: iload_1
    ...
    //   123: invokespecial 80	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   126: astore_0
    //   127: aload_0
    //   128: aload 5
    //   130: invokevirtual 84	java/io/FileInputStream:read	([B)I
    //   133: istore_3
    //   134: iload_3
    //   135: ifle +39 -> 174
    //   138: iconst_0
    //   139: istore_1
    //   140: goto +93 -> 233
    //   143: new 52	java/lang/String
    //   146: dup
    //   147: aload 5
    //   149: iconst_0
    //   150: iload_2
    //   151: invokespecial 87	java/lang/String:<init>	([BII)V
    //   154: astore 4
    //   156: aload_0
    //   157: invokevirtual 91	java/io/FileInputStream:close	()V
    //   160: aload 4
    //   162: areturn
    //   163: astore_0
    //   164: aload 4
    ...
    //   171: goto +62 -> 233
    //   174: aload_0
    //   175: invokevirtual 91	java/io/FileInputStream:close	()V
    //   178: ldc 10
    //   180: areturn
    //   181: astore_0
    //   182: aload 4
    ...
    //   186: ifnull -8 -> 178
    //   189: aload_0
    //   190: invokevirtual 91	java/io/FileInputStream:close	()V
    //   193: goto -15 -> 178
    //   196: astore_0
    //   197: goto -19 -> 178
    //   200: astore 4
    ...
    //   205: ifnull +7 -> 212
    //   208: aload_0
    //   209: invokevirtual 91	java/io/FileInputStream:close	()V
    //   212: aload 4
    //   214: athrow
    //   215: astore_0
    //   216: goto -38 -> 178
  ...
  {
    // Byte code:
    //   0: new 97	java/io/BufferedReader
    //   3: dup
    //   4: new 99	java/io/InputStreamReader
    //   7: dup
    //   8: aload_0
    //   9: invokespecial 102	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   12: invokespecial 105	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   15: astore_2
    //   16: new 60	java/lang/StringBuilder
    //   19: dup
    //   20: invokespecial 107	java/lang/StringBuilder:<init>	()V
    //   23: astore_1
    //   24: aload_2
    //   25: invokevirtual 110	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   28: astore_3
    //   29: aload_3
    //   30: ifnull +40 -> 70
    //   33: aload_1
    ...
    //   37: dup
    //   38: invokespecial 107	java/lang/StringBuilder:<init>	()V
    //   41: aload_3
    ...
    //   60: astore_2
    //   61: aload_0
    //   62: invokevirtual 115	java/io/InputStream:close	()V
    //   65: aload_1
    //   66: invokevirtual 79	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   69: areturn
    //   70: aload_0
    //   71: invokevirtual 115	java/io/InputStream:close	()V
    //   74: goto -9 -> 65
    //   77: astore_0
    //   78: goto -13 -> 65
    //   81: astore_1
    //   82: aload_0
    //   83: invokevirtual 115	java/io/InputStream:close	()V
    //   86: aload_1
    //   87: athrow
    //   88: astore_0
    //   89: goto -24 -> 65
