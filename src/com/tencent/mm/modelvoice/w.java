  ...
  implements b
{
  ...
  public final j R(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      t.d("!44@/B4Tb64lLpKbU59mf71RZFzMaOEttCECeZZozT7o7i8=", "DBG: ReadFile[" + apy + "] readOffset:" + paramInt1 + " readRet:" + i + " fileNow:" + apQ.getFilePointer() + " fileSize:" + l);
      paramInt2 = i;
      if (i < 0) {
        paramInt2 = 0;
      }
    ...
    {
      t.e("!44@/B4Tb64lLpKbU59mf71RZFzMaOEttCECeZZozT7o7i8=", "ERR: ReadFile[" + apy + "] Offset:" + paramInt1 + "  failed:[" + localException.getMessage() + "] ");
      lQ();
      ret = -1;
    }
    return localj;
  ...
  public final int write(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        t.e("!44@/B4Tb64lLpKbU59mf71RZFzMaOEttCECeZZozT7o7i8=", "ERR: WriteFile[" + apy + "] Offset:" + paramInt2 + " failed:[" + paramArrayOfByte.getMessage() + "]");
        lQ();
        return -3;
      }
      bool1 = false;
