...
{
  Context mNu;
  TreeMap<Long, WloginAllSigInfo> mNv = new TreeMap();
  ...
  private static int a(Context paramContext, String paramString, byte[] paramArrayOfByte)
  {
    ...
    //   193: astore_1
    //   194: aload_0
    //   195: invokestatic 108	oicq/wlogin_sdk/tools/util:h	(Ljava/lang/Exception;)V
    //   198: aload_1
    //   199: ifnull +7 -> 206
    //   202: aload_1
    ...
    //   210: astore_1
    //   211: aload_1
    //   212: invokestatic 108	oicq/wlogin_sdk/tools/util:h	(Ljava/lang/Exception;)V
    //   215: aload_0
    ...
    //   223: astore_1
    //   224: aload_1
    //   225: invokestatic 108	oicq/wlogin_sdk/tools/util:h	(Ljava/lang/Exception;)V
    //   228: aload_0
    ...
    //   236: astore_1
    //   237: aload_1
    //   238: invokestatic 108	oicq/wlogin_sdk/tools/util:h	(Ljava/lang/Exception;)V
    //   241: aload_3
    ...
    //   255: astore_1
    //   256: aload_1
    //   257: invokestatic 108	oicq/wlogin_sdk/tools/util:h	(Ljava/lang/Exception;)V
    //   260: aload_3
  ...
  private int b(TreeMap paramTreeMap, String paramString)
  {
    try
    {
      Object localObject2 = new SecretKeySpec(i.mNX, "DESede");
      ...
      i = a(mNu, paramString, ((ByteArrayOutputStream)localObject2).toByteArray());
      return i;
    }
    catch (Exception paramTreeMap)
    {
      for (;;)
      {
        ...
        paramString.flush();
        util.dd("exception", paramString.toString());
        int i = 64514;
      }
    }
    finally {}
  ...
  private static TreeMap bt(Context paramContext, String paramString)
  {
    ...
    //   2: aload_0
    //   3: aload_1
    //   4: invokestatic 190	oicq/wlogin_sdk/request/c:bu	(Landroid/content/Context;Ljava/lang/String;)[B
    //   7: astore 4
    //   9: aload 4
    //   11: ifnull +507 -> 518
    //   14: new 116	javax/crypto/spec/SecretKeySpec
    //   17: dup
    //   18: getstatic 122	oicq/wlogin_sdk/request/i:mNX	[B
    //   21: ldc 124
    ...
    //   123: invokestatic 184	oicq/wlogin_sdk/tools/util:dd	(Ljava/lang/String;Ljava/lang/String;)V
    //   126: aload_0
    //   127: invokestatic 214	oicq/wlogin_sdk/tools/util:hj	(Landroid/content/Context;)[B
    //   130: astore_3
    //   131: aload_2
    //   132: astore_1
    //   133: aload_3
    ...
    //   217: astore_1
    //   218: aload_0
    //   219: invokestatic 217	oicq/wlogin_sdk/tools/util:hi	(Landroid/content/Context;)[B
    //   222: astore_3
    //   223: aload_1
    //   224: astore_2
    //   225: aload_3
    ...
    //   239: dup
    //   240: aload_3
    //   241: invokestatic 223	oicq/wlogin_sdk/tools/c:bC	([B)[B
    //   244: ldc 124
    ...
    //   311: astore_2
    //   312: aload_0
    //   313: invokestatic 226	oicq/wlogin_sdk/tools/util:hh	(Landroid/content/Context;)[B
    //   316: astore_1
    //   317: aload_2
    //   318: astore_0
    //   319: aload_1
    ...
    //   333: dup
    //   334: aload_1
    //   335: invokestatic 223	oicq/wlogin_sdk/tools/c:bC	([B)[B
    //   338: ldc 124
  ...
  private static byte[] bu(Context paramContext, String paramString)
  {
    ...
    //   114: astore_1
    //   115: aload_0
    //   116: invokestatic 108	oicq/wlogin_sdk/tools/util:h	(Ljava/lang/Exception;)V
    //   119: aload_1
    //   120: ifnull +7 -> 127
    //   123: aload_1
    ...
    //   173: astore_1
    //   174: aload_0
    //   175: invokestatic 108	oicq/wlogin_sdk/tools/util:h	(Ljava/lang/Exception;)V
    //   178: aload_1
    //   179: ifnull +18 -> 197
    //   182: aload_1
  ...
  /* Error */
  private WloginAllSigInfo ey(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   22: invokestatic 281	oicq/wlogin_sdk/tools/util:dc	(Ljava/lang/String;Ljava/lang/String;)V
    //   25: aload_0
    //   26: getfield 19	oicq/wlogin_sdk/request/c:mNv	Ljava/util/TreeMap;
    ...
    //   51: areturn
    //   52: aload_0
    //   53: getfield 21	oicq/wlogin_sdk/request/c:mNu	Landroid/content/Context;
    //   56: ifnonnull +8 -> 64
    //   59: aconst_null
    //   60: astore_3
    //   61: goto -13 -> 48
    //   64: aload_0
    //   65: getfield 21	oicq/wlogin_sdk/request/c:mNu	Landroid/content/Context;
    //   68: ldc 111
    ...
    //   103: ldc_w 273
    //   106: ldc_w 296
    //   109: invokestatic 281	oicq/wlogin_sdk/tools/util:dc	(Ljava/lang/String;Ljava/lang/String;)V
    //   112: aconst_null
    //   113: astore_3
    //   114: goto -66 -> 48
    //   117: aload_0
    //   118: getfield 19	oicq/wlogin_sdk/request/c:mNv	Ljava/util/TreeMap;
  ...
  public final int a(long paramLong1, long paramLong2, long paramLong3, long paramLong4, long paramLong5, long paramLong6, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, byte[] paramArrayOfByte4, byte[] paramArrayOfByte5, byte[] paramArrayOfByte6, byte[] paramArrayOfByte7, byte[] paramArrayOfByte8, byte[] paramArrayOfByte9, byte[] paramArrayOfByte10, byte[] paramArrayOfByte11, byte[] paramArrayOfByte12, byte[] paramArrayOfByte13, byte[] paramArrayOfByte14, byte[] paramArrayOfByte15, byte[] paramArrayOfByte16, byte[][] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      try
      {
        WloginAllSigInfo localWloginAllSigInfo = (WloginAllSigInfo)mNv.get(new Long(paramLong1));
        ...
        if ((localObject != null) && (_en_A1 != null))
        {
          ...
          mNv.put(new Long(paramLong1), localWloginAllSigInfo);
          return i;
        }
      }
      finally {}
  ...
  public final void g(Long paramLong)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 19	oicq/wlogin_sdk/request/c:mNv	Ljava/util/TreeMap;
    //   6: aload_1
    //   7: invokevirtual 350	java/util/TreeMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   10: pop
    //   11: aload_0
    //   12: getfield 21	oicq/wlogin_sdk/request/c:mNu	Landroid/content/Context;
    //   15: ifnull +17 -> 32
    //   18: aload_0
    //   19: getfield 21	oicq/wlogin_sdk/request/c:mNu	Landroid/content/Context;
    //   22: ldc 111
  ...
  /* Error */
  public final WloginSigInfo s(long paramLong1, long paramLong2)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   32: invokestatic 281	oicq/wlogin_sdk/tools/util:dc	(Ljava/lang/String;Ljava/lang/String;)V
    //   35: aload_0
    //   36: lload_1
    //   37: invokespecial 358	oicq/wlogin_sdk/request/c:ey	(J)Loicq/wlogin_sdk/request/WloginAllSigInfo;
    //   40: astore 5
    //   42: aload 5
    //   44: ifnonnull +11 -> 55
    //   47: aconst_null
