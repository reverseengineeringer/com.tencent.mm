...
public final class j
{
  ...
  {
    return fv.metaStateHasModifiers(paramKeyEvent.getMetaState(), 1);
  }
  
  public static boolean b(KeyEvent paramKeyEvent)
  {
    return fv.metaStateHasNoModifiers(paramKeyEvent.getMetaState());
  }
    ...
    implements j.d
  {
    ...
    {
      return a(a(normalizeMetaState(paramInt1) & 0xF7, 1, 1, 64, 128), 1, 2, 16, 32) == 1;
    }
