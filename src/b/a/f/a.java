  ...
  implements b
{
  public final String G(String paramString1, String paramString2, String paramString3)
  {
    try
    {
      b.a.g.d.bZ(paramString1, "Base string cant be null or empty string");
      b.a.g.d.bZ(paramString2, "Api secret cant be null or empty string");
      ...
      paramString2 = new String(b.a.g.a.bf(paramString3.doFinal(paramString1.getBytes("UTF-8")))).replace("\r\n", "");
      return paramString2;
    }
