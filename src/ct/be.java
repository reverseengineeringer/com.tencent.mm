...
public final class be
{
  ...
  public be(byte[] paramArrayOfByte)
  {
    a = ByteBuffer.wrap(paramArrayOfByte);
  }
  
  public be(byte[] paramArrayOfByte, byte paramByte)
  {
    a = ByteBuffer.wrap(paramArrayOfByte);
    a.position(4);
  }
  ...
  public final bg a(bg parambg, int paramInt, boolean paramBoolean)
  {
    a locala = null;
    if (a(paramInt))
    {
      try
      {
        parambg = (bg)parambg.getClass().newInstance();
        locala = new a();
        a(locala, a);
        if (a != 10) {
          throw new RuntimeException("type mismatch.");
      ...
      {
        throw new RuntimeException(parambg.getMessage());
      }
      parambg.a(this);
      a();
    }
  ...
  public final Object a(Object paramObject, int paramInt, boolean paramBoolean)
  {
    ...
    if ((paramObject instanceof bg)) {
      return a((bg)paramObject, paramInt, paramBoolean);
    }
