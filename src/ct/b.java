  ...
  extends PhoneStateListener
{
  ...
  private boolean a(CellInfo paramCellInfo)
  {
    ...
    while ((!cv.a(paramCellInfo)) || (cv.a(c, paramCellInfo))) {
      return false;
    }
    return true;
  }
    ...
    for (;;)
    {
      ...
      if (b != null)
      {
        ...
        while (i != 0)
        {
          try
          {
            CellInfo localCellInfo = cv.a(b);
            if (a(localCellInfo))
            {
              ci localci = ci.a(b, localCellInfo);
              if (localci != null)
              {
                c = localCellInfo;
                b.c(localci);
  ...
  public final void b()
  {
    ...
    try
    {
      ...
      e = null;
      f = 0L;
      a.a("TxCellProvider", 4, "shutdown: state=[shutdown]");
      return;
    }
    finally {}
  }
  ...
  public final void onCellInfoChanged(List paramList)
  {
    ...
    if (paramList == null)
    {
      a.a("TxCellProvider", 6, "onCellInfoChanged: cellinfo list is null ");
      c();
      return;
    }
    ...
    for (;;)
    {
      ...
      for (paramList = (CellInfo)paramList.get(0);; paramList = (List)localObject)
      {
        if (a(paramList))
        {
          c = paramList;
