...
public final class cq
{
  ...
  @SuppressLint({"NewApi"})
  public static CellInfo a(bg parambg)
  {
    try
    {
      parambg = parambg.a();
      ...
      localList = parambg.getAllCellInfo();
      if (localList == null) {
        break label104;
      }
  ...
  public static boolean a(android.content.Context paramContext)
  {
    ...
    //   2: iconst_1
    //   3: istore_2
    //   4: getstatic 125	android/os/Build$VERSION:SDK_INT	I
    //   7: bipush 17
    //   9: if_icmplt +25 -> 34
    //   12: aload_0
    //   13: invokevirtual 131	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   16: ldc -123
    //   18: invokestatic 139	android/provider/Settings$Global:getInt	(Landroid/content/ContentResolver;Ljava/lang/String;)I
    //   21: istore_1
    //   22: iload_1
    //   23: iconst_1
    //   24: if_icmpne +5 -> 29
    ...
    //   31: goto -4 -> 27
    //   34: aload_0
    //   35: invokevirtual 131	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   38: ldc -123
    //   40: invokestatic 142	android/provider/Settings$System:getInt	(Landroid/content/ContentResolver;Ljava/lang/String;)I
    //   43: istore_1
    //   44: iload_1
    //   45: iconst_1
    //   46: if_icmpne +7 -> 53
  ...
  public static CellLocation b(bg parambg)
  {
    boolean bool2 = false;
  ...
  public static List<NeighboringCellInfo> c(bg parambg)
  {
    parambg = parambg.a();
    if (parambg != null) {
      try
      {
        parambg = parambg.getNeighboringCellInfo();
        return parambg;
      }
      catch (Exception parambg) {}
    }
